...
# ╔═╡ dac232ca-12cd-11ed-3352-a5e7e037b9cb
begin
using Symbolics,ModelingToolkit,Unitful,Latexify,Plots

@variables t,F,k,s,x(t),m,g,W,l,ω
D = Differential(t)
# g=9.80u"m/s^2"
# m=1.0u"kg"
 W=m*g
# s,x,l=1.0u"m",1.0u"m",1.0u"m"
dx=D(x)
ddx=D(dx)
...
# ╔═╡ 4286ee81-130c-44ed-8e3d-5a5dad1525e5
md"""
# 弹簧-质量 模型
"""

# ╔═╡ fabe7f09-3e71-41dd-b5e2-c9d2655e664e
begin
	tspan=0.2:0.02:6
	f(t)=(5//3)ℯ^(-t)-(2//3)ℯ^(-4t)
	latexify(f(t))
...
manifest_format = "2.0"
project_hash = "740f3f689560bb783a7a943b9a0a98ba0437ed34"
