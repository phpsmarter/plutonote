...
# ╔═╡ 1713feb1-7594-431f-971d-68e9c58b3c89
let
...
begin
	   ...
	   f_value=map(x->x["f"],mapshot)
	  df2=(x=x_value,y=y_value,f=f_value)

end

# ╔═╡ ad92d9ac-88bd-43ae-bd19-adabd188306e
let
set_aog_theme!()

axis = (width = 225, height = 225)
shot_frequency = data(df) * frequency() * mapping(:f)
draw(shot_frequency; axis)
end

# ╔═╡ 54013658-fc88-4255-9f10-a533cb3bfc72
let
