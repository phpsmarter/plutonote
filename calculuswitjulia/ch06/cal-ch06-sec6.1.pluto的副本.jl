...
# ╔═╡ d5ad5714-e77c-11ec-2c13-dd1626e44d4a
begin
...
# ╔═╡ 2b576278-6ba4-409e-87bb-a74d66e88a5a
PlutoUI.Resource("https://tva1.sinaimg.cn/thumbnail/e6c9d24egy1h2alsw1tzxj20m80gomxn.jpg")


# ╔═╡ 2abe99e3-bb68-4164-bc87-cc2d320d3634
md"""
# ch06 sec6.1 反导数的图形和数值特性
"""

# ╔═╡ abcf1c36-9b0a-4feb-8f91-cd7745e425e2
md"""
## 反导函数簇

如果$F$的导函数是$f$,我们就说$F$是$f$ 的反导数. 例如$F=x^2$的导数$f=2x$, $F=x^2$就是$f$ 的反导数

但是有个问题需要注意,由于常数项的导数为 0,所以可以有很多的$F$与导数对应, 例如:
...
# ╔═╡ 9ef370e5-351e-4e46-9cf5-3f521f31c781
# ╠═╡ disabled = true
#=╠═╡
let
	function df(t)
	...
	p1=plot(df, tspan,frame=:zerolines,label=false,ylims=(-1,1),size=(500,500))
	p2=plot(f, tspan,frame=:zerolines,label=false,ylims=(-15,5),size=(500,500))
...
# ╔═╡ a413894a-2c98-46da-bafa-e300c8f2a3c5
md"""
!!! example

    example2 画出 当$x=0$时,$f(x)=e^{-x^2}$的反导数$F$

"""

# ╔═╡ 6d80002e-4f4d-4935-9507-eeaacc04812c
let
	tspan=-2:0.02:2
	f(x)=ℯ^(-x^2)
	p1=plot(f,tspan,label=L"e^{-x^2}",frame=:zerolines)
end

# ╔═╡ 31a8788e-0371-4431-8987-1dd4f0fcab26


# ╔═╡ 11228aaa-89a2-4ccb-9e66-c1b7ff6929d5


# ╔═╡ f4a78598-f9b7-41f5-9d59-9f7b53094b71
