...
# ╔═╡ d4a8b070-ede4-11ec-342b-b7890048415c
begin
...
# ╔═╡ 76c6a4df-dad0-4d51-829c-8f9670251577
PlutoUI.Resource("https://tva1.sinaimg.cn/thumbnail/e6c9d24egy1h2alsw1tzxj20m80gomxn.jpg")


# ╔═╡ f7b6b589-6f46-4e7e-804b-5e903755ce59
md"""
#  ch11 sec11.3  欧拉方法
"""

# ╔═╡ aaee85f5-e7b6-4b08-ab72-8eb747c93f1b
begin
	store=Dict()
...
# ╔═╡ e6e7a354-4fe7-4cf2-86ef-053cae4e3ca1
md"""
...
根据该点的斜率,可以计算出在y 方向的位移, 假设斜率公式(导数) 为$dy/dx=y$
...
我们在看看第二步的情况, 仍然只在$x$ 方向移动 $\Delta x$,由此的x 方向的新坐标为:
...
如果你仔细观察通过欧拉方法获取的解曲线, 会发现曲线并不是那么平滑, 因为我们是在$\Delta x$的范围内用直线来近似曲线, 我们的解曲线实际是由一些小的直线拼接而成. 

如果要让结果更为精确, 我们把$\Delta x$ 的值再取小一点, 比如$0.1 \to  0.05$
...
# ╔═╡ 3eca633c-d809-4cb6-9c52-f7b6114bfd05
let
...
# ╔═╡ 68b8e31f-e470-45f1-81b7-bdc513d0b523
let
...
# ╔═╡ fb0f5219-73b5-4346-a4da-9262098647e3
let
	Δx=0.1
	offset1=(1/2)*Δx
	offset2=Δx-0.02
	...
	function getann1(p)
	     return (
		  p.x+offset1,p.y,text(L"\leftarrow %$(Δx) \rightarrow",pointsize=8,color=:blue)
		 )
	...
	p1=plot(plotdata.x,plotdata.y,frame=:semi,label=false,ann=[annarr1...,annarr2...],size=(400,600),title=L"euler \ method")
...
# ╔═╡ 17de3379-a6c4-46ad-9bd6-03e8cc6f3217
let
	Δx=0.05
	offset1=(1/2)*Δx
	offset2=Δx-0.02
...
# ╔═╡ 27e2983e-d582-4da7-b6da-b3942ea89a93
md"""
...
# ╔═╡ 6955847e-dab7-47f2-a713-773cce9e2ef0
...
# ╔═╡ 75b35d82-9e02-48f3-ab5b-f404a7d282c6
let
  tspan=0:0.02:0.5*pi
  ...
  plot(plotdata.x,plotdata.y,ratio=:equal,frame=:semi,size=(360,360),label="euler approx")
  p3= plot!(xs,ys, label="circle")
  save("plot3",p3)

end

# ╔═╡ 4c95b47e-9c3c-48c4-a769-5ecb5821c7cb
