...
# ╔═╡ c0280212-eaf2-11ec-3b62-2149d0428e61
begin
...
# ╔═╡ df60e9aa-95db-4efd-a5c9-f4ac3a8eae27
PlutoUI.Resource("https://tva1.sinaimg.cn/thumbnail/e6c9d24egy1h2alsw1tzxj20m80gomxn.jpg")


# ╔═╡ 6cbef033-1f74-47f6-83dc-cd1bf25962c4
md"""
# ch08  sec8.6  积分经济学应用
"""

# ╔═╡ 0dbb9a58-e556-4684-aab0-5a5260945a02
md"""
## 现值和未来值
绝大多数交易都可以使用分期的方式, 买东西可以用借记卡或者分期付款, 收入也有应付款. 我们对立即付款和以后付款的方法处理都不同, 心理预期也不同. 

如果是在未来付款, 收款人希望能有对支付进行一定的补偿. 弥补付款时间上的差异. 要达成交易, 必须要知道怎么进行补偿. 

"""

# ╔═╡ d84e1077-3f53-454b-b298-974e79e81de5
md"""
!!! note

    -  当前值(\$P) 的**未来值(future value,\$B)** 值得是如果收入存入银行获取的利息收入
    -  **当前值(\$P present value)**


如果复合年利率为每年$r$,经过$t$ 年时间,存款(\$P)会增长到未来值**\$B**:

$B=P(1+r)^tm,或: P=\frac{B}{(1+r)^t}$


如果是连续计息,可以写为:

$B=Pℯ^{rt},或:P=\frac{B}{e^{rt}}=Bℯ^{-rt}$


"""

# ╔═╡ ea364ef9-b4b2-406a-b6ed-2764977599c5
md"""
!!! example 
    example 1

    假设你中了彩票头等奖, 支付方法有1.总金额 $100$ 万, 分四年, 每年付给你 $25$万. 2 一次性付清,为$92$万, 如果连续计息,年利率为 $6%$,并忽略税收, 你应该选择那种付款方式?
"""

# ╔═╡ 9658a20c-2fc4-48ae-ae1c-ddb602fca040
begin
...
# ╔═╡ 995130f2-2e0c-46cd-9c6a-32353f1604fb
@htl("""<script src="https://cdn.bootcdn.net/ajax/libs/mathjax/3.2.0/es5/tex-svg-full.min.js"></script>
