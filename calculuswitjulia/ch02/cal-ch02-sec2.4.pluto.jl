...
# ╔═╡ d2e31a14-e3d5-11ec-360b-51cf4968eea1
begin
...
# ╔═╡ 6ce60021-54ca-4625-97b6-742620211c03
PlutoUI.Resource("https://tva1.sinaimg.cn/thumbnail/e6c9d24egy1h2alsw1tzxj20m80gomxn.jpg")

# ╔═╡ 524ae980-6ddd-4cba-918a-5074a6184b53
md"""
 ch02 sec 2.3  导数的认识
"""

# ╔═╡ 05da9a72-af91-45ba-aae6-ac58ed486bc7
md"""
两套符号系统

$$\frac{y值的变化}{x 的变化} = \frac{\Delta y}{\Delta x}$$

$$\frac{dy}{dx}  \approx  \frac{\Delta y}{\Delta x}$$
 $\Delta$ 表示变化

需要理解的是,这里的符号和变量一样有意义, 在代数中可以执行移项,约减等操作. 

### 用问题理解和解释导数
对于一个函数, 从它的表达式,我们往往看到的是一个整体, 对于导数, 我们观察的都是局部的情况. 对导数的解释只能适合于局部环境. 在理解或者解释导数的意义,首先就要找到研究的起点是哪里.从这个起点开始会发生什么样的变化
"""

# ╔═╡ c451879a-2723-42b4-bbb6-a61490c35e49
md"""
`example  1`

开采铜矿的开销可以用函数 $C=f(T)$ 表示,   ${f(2000)}'=100$ 的意义是?
	
$$\frac{\Delta C}{\Delta T}=100$$

铜矿开到量达到$T=2000$吨时,  再多开采 $1$ 吨铜, 开销会增加 $100$ 美元 

$$\Delta C=100\Delta T$$

开采总量达到$T=2005$ 吨时, 会近似多开销 $\Delta C=5X100=500$  美元

整个用于计算开采花费的公式可能不是线性的, 但是对于$T=2000$ 这一点附近的开采量,就可以用线性方法来表示, 直线的斜率就是该点的导数
