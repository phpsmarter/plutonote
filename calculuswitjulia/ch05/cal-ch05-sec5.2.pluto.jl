...
# ╔═╡ b8d31f3a-e6d1-11ec-20aa-172c561ba03c
begin
...
# ╔═╡ 41c82b9e-b0c6-422f-9396-552b651fff6e
PlutoUI.Resource("https://tva1.sinaimg.cn/thumbnail/e6c9d24egy1h2alsw1tzxj20m80gomxn.jpg")


# ╔═╡ bc0f424c-a861-48f0-abb6-db94b00732c8
md"""
# ch05 sec5.2 定积分
"""

# ╔═╡ 8149c4fb-ff2d-4fe4-a0d2-bfdb90925d06
md"""
##  取极限得定积分
"""

# ╔═╡ fbeca27b-edea-4855-a3b8-ed0ae54067d9
md"""
!!! definition
    假定$f$在区间 $a\leq t\leq b$,定积分写为:

    $$\int_{a}^{b}f(t)dt$$

    当 $n \to  +\infty,Δt \to 0$
    
    $$\int_{a}^{b}f(t)dt=\lim_{n \to +\infty}(Left-hand- Sum)=\lim_{n \to +\infty}(\sum_{i=0}^{n-1} f(t_i)\Delta t)$$
    $$\int_{a}^{b}f(t)dt=\lim_{n \to +\infty}(Right-hand- Sum)=\lim_{n \to +\infty}(\sum_{i=1}^{n} f(t_i)\Delta t)$$

    左侧和与右侧和都成为黎曼和, $f$ 称为被积函数, $a,b$  称为积分极限
"""

# ╔═╡ dcd129d2-02f8-4499-81af-791e2feb61ce
md"""
!!! example
    example1

    计算$n=2$时, $\int_{a}^{b}\frac{1}{t}dt$ 的左和与右和



因为 $a=1,b=2,n=2$  所以 $\Delta t=\frac{2-1}{2}=0.5$
"""

# ╔═╡ 625d05c2-50dc-43a7-98be-4ed2472fa22d
let
	a=1
	b=2
	n=2
	...
	@show leftsums=pipeline(tspan[1:2])
	@show rightsums=pipeline(tspan[2:3])
	
end

# ╔═╡ b654772d-cf13-450e-a74f-c4c67ef8f4d6
begin
...
# ╔═╡ 3f10c352-77ca-4a90-94b0-393306c6f9ea
begin
   func1(t)=1/t
   n2= getRiemannSum(1,2,2,func1)
   n10=getRiemannSum(1,2,10,func1)
   n250=getRiemannSum(1,2,250,func1)
   @show n2 n10 n250
  
end

# ╔═╡ b13112b2-baf4-4c16-bb98-765160092139
md"""
!!! note
    当$n=250$时, 左侧和与右侧和之间的差距非常小,因此可以得出结论:

    $$\int_{a}^{b}\frac{1}{t}dt \approx 0.69$$
"""

# ╔═╡ 27cc3aac-50af-437a-b957-fe73134acbd7
md"""
!!! example 
    example2

    计算$$\int_{-1}^{1}\sqrt{1-x^2}dx$$的积分
...
# ╔═╡ 10121f3e-7b71-453e-bfaa-18e3f2ab0f09
begin
   func2(t)=sqrt(1-t^2)
   rn10= getRiemannSum(-1,1,10,func2)
   rn50=getRiemannSum(-1,1,50,func2)
   rn250=getRiemannSum(-1,1,250,func2)
   @show rn10 rn50 rn250
  
end

# ╔═╡ 41a63632-bfc7-4ac1-9f46-437f04fc19d3
