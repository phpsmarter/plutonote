...
# ╔═╡ f25eb1d2-3d90-4845-a364-c689b7858902
begin
	using Plots, DifferentialEquations,SymPy,PlutoUI
	
end

# ╔═╡ 3cf776d8-a26b-11ec-0ef8-9929ef4d73d4
md"# second order ode 
   [Ordinary differential equation solvers in Julia] (https://computationalmindset.com/en/neural-networks/ordinary-differential-equation-solvers-in-julia.html)
"

# ╔═╡ e44c51f7-530c-4f33-bae5-0e54ef9e98e1
let
	   f(du,u,p,t) = du
		tspan = (-1,4)
		u_init=0
		du_init=2
		prob = SecondOrderODEProblem(f, du_init, u_init, tspan)
		sol = solve(prob, Tsit5(), reltol=1e-8, abstol=1e-8)
		num_sol = [u[2] for u in sol.u]
		plot(num_sol,sol.t)
