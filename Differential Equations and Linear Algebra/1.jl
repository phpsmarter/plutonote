...
# ╔═╡ ebba89df-923f-498b-b05f-31250955038c
begin
...
# ╔═╡ 36e50912-80a0-11ec-2318-b3cbe84dae6f
md"# Prof. Strang's  textbook 1"

# ╔═╡ 36032901-3bf2-408a-9f6b-e883ee64ee90
@bind  ut  Select([3/4,1/2,1/4,0])

# ╔═╡ 7e88db50-16cf-442e-8b1b-4a1aeffc0edc
begin
f(u,p,t) = 3-6u
u1 = 0.75
u2=0.25
...
plot(sol1,linewidth=1,title=" y' = 3 - 6y  ",
     xaxis="Time (t)",yaxis="u(t) (in μm)",label="u0=3/4") # legend=false
plot!(sol2, lw=1,ls=:dash,label="u0=1/4")
plot!(sol3, lw=2,ls=:dot,label="u0=2/4")
end
