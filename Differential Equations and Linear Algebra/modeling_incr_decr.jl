...
# ╔═╡ 3b7df9b5-5acc-4d53-8974-f046594f3b38
begin
using DifferentialEquations,Plots,PlutoUI,Markdown, ModelingToolkit
	  gr()

end 

# ╔═╡ 64213ab8-1323-415e-8b04-e5950f3da22c
let
...
# ╔═╡ e6d80983-3c85-4aa2-98e9-28cf9757ee1a
let
...
# ╔═╡ 1fd30f82-80c1-11ec-13d3-bd87e466194e
md"# modeling  increasing and decreasing function"

# ╔═╡ d7ab8978-82d2-4cf1-9620-15a8d9bdfec1
begin
...
sol = solve(prob, Tsit5(), reltol=1e-8, abstol=1e-8)
 plot(sol,linewidth=5,title="ode solution",
      xaxis="Time (t)",yaxis="u(t) (in μm)",label="sol!") # legend=false
# plot!(sol.t,x->1/16*x^4)
end


# ╔═╡ c3b64f76-3167-4688-ac07-eeb3d9bef910
@show  sol

# ╔═╡ d5a9d6a2-6279-4404-b397-a4b97978460d
md"## mit. computational thinking   section 1.9.  ode.  example"

# ╔═╡ d7df7cec-6bdf-44c3-9ce8-0add38bd4101
md"### mtk package  example"

# ╔═╡ 8735f5da-a8e7-4d10-9e7c-1b69cd6160b8
md"### initial value family"

# ╔═╡ 9e042351-7f16-41f7-9163-4db1f91bf48c
