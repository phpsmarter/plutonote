...
# ╔═╡ c9f2b9d8-0b20-11ed-34a2-1bd2dce229dc
begin
   using Symbolics,Plots, PlutoUI,Latexify,Unitful,UnitfulLatexify
end

# ╔═╡ eca9ab52-a177-4151-8b1f-05c7514907ef
let
...
# ╔═╡ 581fe355-61e9-42ff-ab2e-a5067343eb16
let
...
# ╔═╡ 43bf9969-0261-43de-ba87-8bcdad62917f
let
	a = 9.82u"m/s^2"
    t = 4u"s"
     x = a*t^2
...
# ╔═╡ 08de2db1-94b4-4268-af5e-fa0ad6e3fa2f
md"## The Efficiency of an Engine"

# ╔═╡ b56b825c-ff0a-4b8c-9d31-7eff829395fa
let
	@variables qh, qc, e, W, p, Δt
...
# ╔═╡ 1834680e-8add-4e28-9c92-417b83f74a7b
let
	1.0u"V/sqrt(Hz)"
