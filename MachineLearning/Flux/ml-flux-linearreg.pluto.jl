...
# ╔═╡ 8300f4fc-2d80-11ed-1a2f-8b5527a9e26d
begin
	using Flux,Latexify
	using Flux:train!
end

# ╔═╡ 44dc41b8-0210-49cf-9a1d-27ed8373eeaa
md"""
## Flux  流程
...
# ╔═╡ 01377b5f-d423-4a02-be20-8b745b5b00e9
begin
	actual(x) = 4x + 2
...
# ╔═╡ 8a5df810-0357-4666-9775-556f0dedd280
model = Dense(1 => 1)

# ╔═╡ c0c7c23e-433b-487d-8951-17856137416e
predict = Dense(1 => 1)

# ╔═╡ 6d5da1c1-1f14-496c-b87e-aa0c9e627056
predict(x_train)

# ╔═╡ efff3ca4-e629-4040-b690-707a9a5524c8
loss(x, y) = Flux.Losses.mse(predict(x), y);

# ╔═╡ ea0d729b-9d1a-4b75-9cb6-a6bc77350d58
loss(x_train, y_train)

# ╔═╡ 9074135c-cb44-4acf-9f00-9085c1bc1372
opt = Descent()

# ╔═╡ b8e316cc-3615-4988-9385-7044372f1e8b
data = [(x_train, y_train)]

# ╔═╡ 69c30a41-78fc-4252-9fe8-9afb9bb519fd
parameters = Flux.params(predict)

# ╔═╡ b27a45a3-3f64-43d9-94a1-aba500e54ffe
train!(loss, parameters, data, opt)

# ╔═╡ 3809e40b-2c31-4dfe-bd51-7b72c81fe75a
for epoch in 1:50
         train!(loss, parameters, data, opt)
end

# ╔═╡ e00d4e44-0c70-4e48-b777-565be2133aeb
loss(x_train, y_train)

# ╔═╡ 6643475b-e661-450b-8058-c4b24547d614
parameters

# ╔═╡ b2df0ca6-6e26-456e-86ce-8670cbb376db
latexify(Dict("predict"=>predict(x_test),"actual"=>y_test))
...
manifest_format = "2.0"
project_hash = "279968c84056b2ae6a8838e1afecdecf5467e153"
