...
# ╔═╡ 163b98ee-2e8a-11ed-321f-29d9bc848438
begin
	using ManifoldLearning,Plots
end

# ╔═╡ 38becbba-d262-49f6-bc6f-cc56a84bdd72
X, t = ManifoldLearning.swiss_roll(segments=4); #生成四个类别的瑞士卷数据

# ╔═╡ 0948bbc9-0e87-446a-a482-32cf762ffc95
begin
    x,y,z=X[1,:]|>vec,X[2,:]|>vec,X[3,:]|>vec
	scatter3d(x,y,z,zcolor=t,label=false )
end

# ╔═╡ 5038ecd0-7ca7-4b5f-ace6-a5784a3f3f7f
#fit(TSNE, X;)|>transform|>plot_res  #tsne 速度较慢, 其他代码运行完之后再去掉注释运行

# ╔═╡ 6a2db99a-0af2-48b2-9c17-768ae9ae8395
plot_res(R)=scatter(R[1,:],R[2,:],zcolor=t,label=false,frame=:box)

# ╔═╡ b671866b-0e1a-4abe-954d-61f094c09d3c
fit(Isomap, X;)|>transform |>plot_res

# ╔═╡ c9cea6b0-b123-4c61-ad4f-e82eb5978b74
fit(HLLE, X;)|>transform |>plot_res

# ╔═╡ 038237c7-22c7-475d-8087-8f71c5b11470
fit(DiffMap, X;)|>transform |>plot_res
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "bdd8a5b1beaa9b92df782a1afa2f77875f643ab8"
