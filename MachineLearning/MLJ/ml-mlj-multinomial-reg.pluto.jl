...
# ╔═╡ 774716e8-2e66-11ed-2731-c7030ada70c1
begin
...
# ╔═╡ f618f14d-95f4-40fb-92b8-6c306dfa77be
md"""
## 1. 多项式回归
"""

# ╔═╡ 1a88d983-ef08-4742-908e-3b68b4aeea46
LR = @load LinearRegressor pkg=MLJLinearModels

# ╔═╡ 6d896d35-1962-446c-9b48-989e0bae1370
begin
	p1=scatter(X.Horsepower, y,ms=2, color=:lightgreen,label="data", xlabel="Horse Power",ylabel="MPG",size=(500,400),frame=:box)
end

# ╔═╡ b5e99879-4771-416a-81dc-5c2261278589
begin
	lm = LR()
...
# ╔═╡ cd5590da-a638-413f-b43e-b1346d6a1c55
begin
...
# ╔═╡ 912ec8c2-ef50-4a3c-baa6-7d87cbfccadf
begin
	hp = X.Horsepower
	Xhp = DataFrame(hp1=hp, hp2=hp.^2, hp3=hp.^3);
end

# ╔═╡ dafc835c-1cfb-447c-af22-9f13715c63e8
LinMod = Pipeline(
    FeatureSelector(features=[:hp1]),
    LR()
);

# ╔═╡ bb0d3ecb-10d2-441c-b274-5ef296fbf843
begin
...
# ╔═╡ 1279aee0-b4e5-470d-8f8c-0c1428285b06
begin
...
# ╔═╡ 30d41401-2260-4d94-98f3-8b2e8654fabd
begin
	hpn  = xx.Horsepower
	...
	scatter(X.Horsepower, y,ms=2, color=:lightgreen,label="data", xlabel="Horse Power",ylabel="MPG",size=(500,400),frame=:box)
	plot!(xx.Horsepower, [yy1,yy2,yy3], lw=2,label=["Order 1" "Order 2" "Order 3"])
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "22e6015742a1ce600b089c8f803d30c5c47c1075"
...
[[deps.MLJModels]]
deps = ["CategoricalArrays", "CategoricalDistributions", "Dates", "Distances", "Distributions", "InteractiveUtils", "LinearAlgebra", "MLJModelInterface", "Markdown", "OrderedCollections", "Parameters", "Pkg", "PrettyPrinting", "REPL", "Random", "RelocatableFolders", "ScientificTypes", "StatisticalTraits", "Statistics", "StatsBase", "Tables"]
git-tree-sha1 = "fe1033e8a25769037760298f0be28b4cff52d83c"
