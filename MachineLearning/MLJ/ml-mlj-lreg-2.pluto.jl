...
# ╔═╡ 49fbc0e8-2df9-11ed-1cea-0775637d7b14
begin
	using MLJ,RDatasets,CSV,DataFrames,StatsPlots
	using   MLJLinearModels,MLJScikitLearnInterface,MLJGLMInterface
    LinearRegressor = @load LinearRegressor pkg=MLJLinearModels
end

# ╔═╡ c1b7e1da-7b85-4096-b345-da918f8b1e77
begin
	path="/Users/lunarcheung/Public/github/StatsWithJuliaBook/data/cars.csv"
	data=CSV.read(path, DataFrame).|>float
	row,col=size(data)
	X,y=data[!,1],data[!,2]
	
end

# ╔═╡ 94e27d86-75c6-4797-8a80-486220fadf01
data|>first

# ╔═╡ 54cd25f6-9e76-4798-a472-78f75591996d
begin
sdl = LinearRegressor()
X_uni = select(data, :1)
mach_uni = machine(sdl, X_uni, y)
fit!(mach_uni)
end

# ╔═╡ 9a5c48d6-bfe1-4944-bf26-5632614f1204
fp = fitted_params(mach_uni)

# ╔═╡ 5f1a1ab7-0df5-4feb-b06c-1f42e4cb4aa6
begin
	new_x=DataFrame(:speed=>1:1:25)|>d->select(d,:speed)|>Matrix
	
	scatter(data[!,1],data[!,2],label=false,ms=3,ma=0.7,mc=:lightblue)
	
	plot!(new_x, MLJ.predict(mach_uni,new_x),label=false)
end
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "61c8440b04102fe1657e6f746d2fd9ddaec116e4"
