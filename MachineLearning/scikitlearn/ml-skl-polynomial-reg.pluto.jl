...
# ╔═╡ 37053a18-2e72-11ed-2191-9374905ce4a2
begin
	using ScikitLearn, Random,DataFrames,Polynomials,Latexify,Symbolics,CSV,StatsPlots
	@sk_import preprocessing : PolynomialFeatures
	@sk_import linear_model : LinearRegression
    @sk_import   pipeline : Pipeline
end

# ╔═╡ 5369f4a3-bf31-482a-90cc-244866ba3b0c
begin
	X =reshape(1:6,3, 2)
...
# ╔═╡ 3aad9d6b-21f4-4eb9-8fa7-a4432adf3120
begin
model = Pipeline([("poly", PolynomialFeatures(degree=3)),("linear",LinearRegression(fit_intercept=false))]) 
end

# ╔═╡ 9356f715-5757-465a-9260-042fc0fd5bc5
begin
	@variables x1,y1
...
# ╔═╡ e5f28172-0291-4cd3-b08f-d02005e9bcac
model.named_steps["linear"].coef_|>Array.|>(d->round(d,digits=2))|>d->Polynomial(d,:x)|>println


# ╔═╡ 131fbe62-0831-45a0-959f-832b060e676b
md"""
## 2. 使用下面的的数据进行多项式回归拟合
"""

# ╔═╡ 4452d434-ae31-416e-971c-7a7579d1acc5
begin
	## 多项式数据
...
# ╔═╡ 614e508c-6761-4c66-81d3-86fadfdb63a4
begin
...
# ╔═╡ dacfe7d3-31a7-4608-9417-31f021dc025e
begin
	@variables x3,y3
y3=model2.named_steps["linear"].coef_|>Array.|>(d->round(d,digits=2))|>d->Polynomial(d,:x3)
end

# ╔═╡ eb4c234a-0c9e-41b7-a37e-d572e586ea93
begin
	range=-6:0.2:6
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "f338b8eaa36d2a610593b200e196608a27837016"
