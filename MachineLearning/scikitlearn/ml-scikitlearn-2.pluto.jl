...
# ╔═╡ 1626a1ae-2dd4-11ed-1c59-51aaacab0347
begin
	using RDatasets,ScikitLearn,DataFrames
	using ScikitLearn.GridSearch: GridSearchCV
end

# ╔═╡ 45f974d6-35ec-4773-af2a-1bff43048c93
begin
...
# ╔═╡ edb1ff0d-e703-49c8-8058-4fb4f7cc720a
begin
...
# ╔═╡ a113d355-d5da-4990-840e-69b3ec42d3c1
res=fit!(model, X, y);

# ╔═╡ 0916052b-46a5-41e9-9ada-1bd4d751d2c4
res.score(X,y)

# ╔═╡ 33280065-f732-49d9-a84d-91bf6674d95b
begin
	gridsearch = GridSearchCV(LogisticRegression(max_iter=200), Dict(:C => 0.1:0.1:2.0))
	fit!(gridsearch, X, y)|>d->d.best_params_
end
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "cf695adb90322f49ee3d3a098662bd76b2ba4087"
