...
# ╔═╡ 61cb1022-2e83-11ed-1cb4-33619cc0de03
begin
	using ScikitLearn, StatsPlots, DataFrames,RDatasets
...
# ╔═╡ c4226bbd-01b9-4484-b2a6-e46f8e097e30
iris = dataset("datasets", "iris");

# ╔═╡ f2b4d1de-51ad-4a3a-853b-bc6837d55d2e
skf = StratifiedKFold(n_splits=4)

# ╔═╡ 7d21fd4a-fd88-4a16-8f0e-ea657f2676ab
x_train, y_train=iris[1:2:end, 1:4],iris[1:2:end,5]

# ╔═╡ 70a4916c-7d4c-47dc-baed-942e59d50067
x_test, y_test=iris[2:2:end, 1:4],iris[2:2:end,5]

# ╔═╡ 11535072-356f-42b3-8eae-b52f59900534
n_classes = y_train|>unique|>length

# ╔═╡ 4519935b-ed57-42bc-8b66-966485aeae2b
begin
	 get_gmm(type)= GaussianMixture(
        n_components=n_classes, covariance_type=type, max_iter=20, random_state=0)

	estimators = [get_gmm(cov_type)   for cov_type in ["spherical", "diag", "tied", "full"]]
end

# ╔═╡ a74609c6-59f5-4087-93c7-803fb73c6026
n_estimators = length(estimators)

# ╔═╡ 4368d392-11d5-43a2-8553-e019f53ed1d5
begin
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "8edf60776547dd113419ab7cb1151890e78d14a6"
