...
# ╔═╡ 2224087e-2f1f-11ed-29d9-8f52b80b6125
begin
	using ScikitLearn, StatsPlots
	@sk_import svm: SVC 
	@sk_import svm:  LinearSVC
	@sk_import datasets: load_iris
	@sk_import inspection:DecisionBoundaryDisplay
end

# ╔═╡ 2552495a-d5e5-42da-a866-2176041e1111
md"![](https://tva1.sinaimg.cn/small/e6c9d24egy1h5z0wwpbphj204g01mwec.jpg)"

# ╔═╡ c0041469-4eff-476d-ac31-d85936a90067
md"""
#  ScikitLearn  SVM  示例
"""

# ╔═╡ d34a4cb9-f359-422b-b4d4-461220bd799e
md"""
## ①  simple  demo
"""

# ╔═╡ d5b6a616-ce87-4fba-9ea0-896a3bd0e905
clf =SVC()

# ╔═╡ b052eedc-e4ea-48a0-bbc3-3553e9b91250
X ,y= [[0, 0], [1, 1]],[0, 1]

# ╔═╡ 02565532-bf41-4058-8b5d-ed44a4874c21
res=clf.fit(X,y)

# ╔═╡ 8b094cfa-1b1e-4287-9537-9a9fa4f482d1
clf.predict([[2., 2.]])

# ╔═╡ e7f4c03c-05a2-4868-9372-75957c8e3227
clf.support_vectors_

# ╔═╡ e2a511e0-a991-4538-b26f-2d7d03aa131b
md"""
## ② 多类别的SVM 分类器
"""

# ╔═╡ 491b2381-a469-421a-9e7f-97ae1bc49ff2
iris =load_iris()

# ╔═╡ acdc94e7-f8cd-4602-91c8-bde630e76b8d
X2 ,y2= iris["data"][:, :2],iris["target"]


# ╔═╡ 6296dad6-f936-499d-b109-0fedcb40f0bb
begin
...
# ╔═╡ 15da15c1-c097-4d0f-ba2e-9933eea13246
begin
	titles = [
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "58e24a7d88ad7bc4939e3cb8ee42b61e9d03e62a"
