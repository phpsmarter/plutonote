...
# ╔═╡ cd858128-2a4e-11ed-182b-d10d072c47d8
begin
	using MLDataUtils
end

# ╔═╡ 3381d0aa-f008-42dc-a6bf-ec7cc48da9f1
md"""
## 1. normalization
"""

# ╔═╡ 775b93d7-c6a7-4c4c-b618-0211d1eb40e1
begin
	x = collect(-5:.1:5)
X = [x x.^2 x.^3]'
...
# ╔═╡ 0e4dd857-6b77-4d38-9422-646a4b353c3f
X

# ╔═╡ 214924c6-7fab-450b-bab2-708019d58c74
X_norm=X

# ╔═╡ 6f560f00-811e-46a0-a103-e38008327777
rescale!(X_norm)

# ╔═╡ b1a30bd6-57e9-4edf-9a95-ba5ef0353e63
X_norm

# ╔═╡ dcd7384f-f184-4757-9cf0-1ba17a9e8049
md"""
## 2. load data
"""

# ╔═╡ 28f22ead-07e9-4019-8e1a-b3320db19b58
load_line()

# ╔═╡ 0e723afb-0e5c-4091-a1b8-68048ade9cfb
X_iris, y_iris, names = load_iris()
...
manifest_format = "2.0"
project_hash = "56d740c0d4d2df81c720dd54832d7f250876d0fc"
