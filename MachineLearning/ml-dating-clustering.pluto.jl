...
# ╔═╡ 6a092ef5-a457-4084-88a7-061bed6c8fc6
begin
	using CSV, DataFrames,Clustering,StatsPlots
	
	using MLDataUtils:rescale!
	
end

# ╔═╡ ce09b5ca-2a89-11ed-27e1-7b1fe21e48aa
md"""
  machine learning action  第二章的约会分类实例
"""

# ╔═╡ 48f68940-6d17-4163-a612-abb70190c5c8
begin
url="/Users/lunarcheung/Public/github/StatsWithJuliaBook/data/datingTestSet2.txt"
rawdata = CSV.read(url,DataFrame)|>d->rename!(d,[:miles,:game,:icecreame,:grade])
end

# ╔═╡ 906aab6e-493a-44d7-af33-232d5873c48f
rawdata|>first

# ╔═╡ af6dcf1d-b15d-40a6-888d-6c7599b6f8fc
begin
	features = collect(Matrix(rawdata[:, 1:3])'); # features to use for clustering
    rescale!(features) 
	
end

# ╔═╡ 35b45085-b9a2-4d97-b66d-89b2ed7f0441
res=kmeans(features, 3)

# ╔═╡ ebfc3775-02c6-408c-a3ef-4aa760c2fab1
let
gr()
color=[:RdYlBu_5 :BuGn_3 :PRGn_4]

scatter(rawdata.miles,rawdata.game, marker_z=res.assignments,
         legend=false,title="k-means clustering")

end

# ╔═╡ aceb82aa-d17c-449f-9ab3-55414b654a86
 scatter3d(rawdata.miles,rawdata.game, rawdata.icecreame, marker_z=res.assignments,
          legend=false,title="k-means clustering")
...
manifest_format = "2.0"
project_hash = "ed85258b2bffd3ec64f15ed7c1b65e9c2f0d2da0"
