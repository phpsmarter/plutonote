...
# ╔═╡ d96282e2-2a0e-11ed-38b5-cb62581c7c4e
begin
	using DataFrames,CategoricalArrays
	using MLDataUtils: shuffleobs, splitobs, rescale!
end

# ╔═╡ 4807a823-3582-430a-8a21-f01e799eac61
begin
	data=[1 3 1;
	...
	v = categorical([1, 1, 1, 0])
	insertcols!(df, :label=>v)
end

# ╔═╡ 2746aeb4-7f3e-4b48-9c8d-bf62febd7ac8
   X=df[:,1:3]

# ╔═╡ 609c042b-4826-41fa-b11a-c863b772a1f4
μ, σ=rescale!(X)


# ╔═╡ 182be462-96c6-41b1-aa34-5950f9d6da83
X

# ╔═╡ 5a862f90-1ac2-456f-a2d1-5b611797e40b
text=Float64[2,4,2]

# ╔═╡ 142e5786-9823-41e7-af3c-f6145ad77e17
rescale!(text, μ, σ)

# ╔═╡ c8caf99f-62ba-416a-94f4-c359509640b8
text
...
manifest_format = "2.0"
project_hash = "6f7004f8301ebe4701126da72df3f719e7432ee2"
