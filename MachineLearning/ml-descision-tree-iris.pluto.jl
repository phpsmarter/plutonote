...
# ╔═╡ d0021b68-2a90-11ed-2aec-9391643312c7
begin
	using DataFrames, DecisionTree,RDatasets,StatsPlots
end

# ╔═╡ 98fe955c-e3cf-41d8-a40d-f4ea43030694
data =dataset("datasets", "iris")|>DataFrame

# ╔═╡ 709cd149-43ec-4246-85cb-6ba912cfcc98
features,labels=Matrix(data[!,1:4]) ,string.(data[!,:5])

# ╔═╡ d64aa3ff-7387-4d2f-9b43-a5229eae5404
model = build_tree(labels, features)

# ╔═╡ 7013d707-64ff-4411-9eef-9c7df2815a31
model2 = prune_tree(model, 0.9)

# ╔═╡ 9eff1db8-6f95-4fce-a06f-9f51bf7d5f46
print_tree(model2)

# ╔═╡ 94892726-a541-435d-9a6d-72646431d323
...
manifest_format = "2.0"
project_hash = "e0004da6aeeb7f56ea5001cefe6f2ad516db0dfb"
