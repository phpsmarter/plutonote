...
# ╔═╡ 0c838af8-3406-11ed-0b27-6bb3c7084b26
begin
	using StatsPlots,StatsBase,LaTeXStrings
end

# ╔═╡ 825229e3-509d-4eee-9a1a-2153f080718d
begin
	w¹₁₁=-1
	w¹₂₂=1
    w¹₁₂=1
	...
	ann=[
		(1,2,
text(L"1", pointsize=14, halign=:center, valign=:center)),
			(2,2,
text(L"2", pointsize=14, halign=:center, valign=:center)),
		(1,3,
text(L"1", pointsize=14, halign=:center, valign=:center)),
		(2,3,
text(L"2", pointsize=14, halign=:center, valign=:center)),
   (1,0.8,
text(L"x_1", pointsize=14, halign=:center, valign=:center)),

	 (2,0.8,
text(L"x_2", pointsize=14, halign=:center, valign=:center)),

     (1,3.4,
text(L"y_1", pointsize=14, halign=:center, valign=:center)),

	 (2,3.4,
text(L"y_2", pointsize=14, halign=:center, valign=:center)),
	  (0.8,1.5,
text(L"%$(w¹₁₁)", pointsize=14, halign=:center, valign=:center)),
	   (1.8,1.5,
text(L"%$(w¹₂₂)", pointsize=14, halign=:center, valign=:center)),
	    (2.2,1.5,
text(L"%$(w¹₁₂)", pointsize=14, halign=:center, valign=:center)),
...
text(L"%$(w¹₂₂)", pointsize=14, halign=:center, valign=:center)),
	...
	scatter(input_layer[1,:],input_layer[2,:],label=false,xlims=(0,3),ylims=(0,4),ms=6,ma=0.5,ann=ann,axis=false,grid=false)
	scatter!(hidden_layer1[1,:],hidden_layer1[2,:],label=false,xlims=(0,3),ylims=(0,4),ms=24,ma=0.5)
	scatter!(ouput_layer[1,:],ouput_layer[2,:],label=false,xlims=(0,3),ylims=(0,4),ms=24,ma=0.5)
	quiver!([1],[1],quiver=([0],[0.8]))
	quiver!([1],[1],quiver=([0.9],[0.8]))
	quiver!([2],[1],quiver=([0],[0.8]))
	quiver!([2],[1],quiver=([-0.9],[0.8]))
	quiver!([1],[2],quiver=([0],[0.8]))
	quiver!([1],[2],quiver=([0.9],[0.8]))
	quiver!([2],[2],quiver=([0],[0.8]))
	quiver!([2],[2],quiver=([-0.9],[0.8]))
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "805582efb8a4babfade6707c766b2ddada91b313"
