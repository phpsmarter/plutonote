...
# ╔═╡ 712f76b6-2e97-11ed-392c-53244264423b
begin
	using ManifoldLearning,Plots,CSV,DataFrames,ScikitLearn
	@sk_import datasets: load_digits
	import ManifoldLearning: fit,transform
end

# ╔═╡ 0f14bbfc-cacf-43dd-9856-f8a21bb4915d
begin
...
# ╔═╡ 5cbac06e-2966-46c5-ad37-03b83876ca78
#fit(TSNE, X_digits' ;maxoutdim=2)|>transform|>transpose|>plot_res

# ╔═╡ 1d008bfc-4024-4eaf-8b3d-5d530be01105
plot_res(R)=scatter(R[:,1],R[:,2],zcolor=t,frame=:box,size=(600,600,600))
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "b9ce6da073109f02b599cc5aa2bcbfa4214f8c59"
