...
# ╔═╡ 2f4cae66-3708-11ed-0b54-536b0c4d097a
begin
	using Gadfly, RDatasets
    iris = dataset("datasets", "iris")
	p1=plot(iris, x=:SepalLength, y=:SepalWidth, Geom.point);
	
end

# ╔═╡ fb32c275-2b71-46c6-ac6b-235994a75fea
plot(iris, xgroup="Species", x="SepalLength", y="SepalWidth",
     Geom.subplot_grid(Geom.point))

# ╔═╡ ea889c6d-f847-465b-89d9-9ad81af38a38
begin
...
# ╔═╡ 005ad458-3c26-4034-bf98-5a546bbacaca
let
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "19dbd0a6fc3c18c9d5d4b925b2eeb482f889500b"
