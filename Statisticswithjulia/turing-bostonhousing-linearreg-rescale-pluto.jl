...
# ╔═╡ 6707299c-2873-11ed-3d41-43751bebeb5b
begin
	using Distributions, StatsPlots, Turing,CSV, DataFrames,MCMCChains, Plots,Distances,Random,Symbolics,Latexify
	using MLDataUtils: shuffleobs, splitobs, rescale!
	Turing.setprogress!(false);
	train_data_url="/Users/lunarcheung/Public/github/StatsWithJuliaBook/data/boston_housing_train.csv"
	test_data_url="/Users/lunarcheung/Public/github/StatsWithJuliaBook/data/boston_housing_test.csv"
	Random.seed!(0)
    
end

# ╔═╡ 0f7254e7-db51-42b8-b067-4efee3465ca1
md"""
 # 预测房价
  rescale method
"""

# ╔═╡ 1c42ac63-fbab-4731-b55f-e311a2d78322
data=CSV.read(train_data_url,DataFrame)

# ╔═╡ 90f84002-0393-4cc0-8e29-2b4c3b401d14
test_data=CSV.read(test_data_url,DataFrame)

# ╔═╡ bc963b40-0afb-4707-8116-a46aa780d437
name=names(data)

# ╔═╡ fe98c5de-4a88-4eee-b802-5832a860f607
begin
	
#select!(data, Not([:chas,:black]))
trainset, testset = splitobs(shuffleobs(data), 0.7)
numerics=[name[2:4]...,name[6:9]...,name[12:15]...]
...
# ╔═╡ 64c17e69-f77d-4db3-a71b-25215f0d7c5a
begin
...
p4 = GLM.predict(ols)
train_prediction_ols = μtarget .+ σtarget .* p4

# Compute predictions on the test data set
# and unstandardize them.
test_with_intercept = hcat(ones(size(test, 1)), test)
p5 = GLM.predict(ols, test_with_intercept)
test_prediction_ols = μtarget .+ σtarget .* p5;
end

# ╔═╡ 163b3b87-b8e0-42a2-a937-e5944c65957d
begin
...
# ╔═╡ edffc6a2-cd3d-4175-b007-1598fb25c6bb
begin
	model = linear_regression(train, train_target)
	chain = sample(model, NUTS(0.65), 3_000);
end

# ╔═╡ 63f3886c-d990-4fed-8852-d741390996b3
begin
	plot(chain)
end

# ╔═╡ 78ad7b47-fdcc-4caf-a367-9442042b0000
describe(chain)

# ╔═╡ 856a1d44-6b0a-4ddf-ba73-de3604fa3baa
...
# ╔═╡ 2497f252-7205-40a8-8046-d43a315e8d8a
begin
# Calculate the predictions for the training and testing sets
# and unstandardize them.
p1 = prediction(chain, train)
train_prediction_bayes = μtarget .+ σtarget .* p1
p2 = prediction(chain, test)
test_prediction_bayes = μtarget .+ σtarget .* p2

# Show the predictions on the test data set.
DataFrame(; medv=testset[!, target], Bayes=test_prediction_bayes, OLS=test_prediction_ols)
end

# ╔═╡ bb113704-6214-44d8-90ed-842b82f3fb08
begin
	println(
    "Training set:",
    "\n\tBayes loss: ",
...
# ╔═╡ b7fa83b0-933d-4fa5-8e71-ddef1bb533c0
md"""
!!! notice
...
manifest_format = "2.0"
project_hash = "7fbd34bcf1be4d623eb3247f349d42e938b3b899"
...
git-tree-sha1 = "5468ab4ea87d8c3fe56b5dad4aaf0d8bcfdf00f6"
