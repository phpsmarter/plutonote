...
# ╔═╡ 3f3edb96-19ee-11ed-200e-93df30c6aa98
begin
	using PlutoUI, Distributions,DataFrames,Statistics,Plots,StatsPlots,Random,StatsBase,Images, FileIO,HTTP,LaTeXStrings

	 TableOfContents(title="中心极限定律")
end

# ╔═╡ 1d1276fd-f477-4390-a6a7-c75ee17c60f3
begin
	Random.seed!(0);
	n=1000
end

# ╔═╡ 220be86e-7317-465c-bd88-1778050c49bf
md"""
 # ch07 中心极限定律和大数定律

!!! warining
	在抽样统计中我们只是想获得总体的参数近似信息,不需要考虑总体的其他信息, 包括总体的分布如何. 
    例如从一个均一分布得到的样本均值符合正态分布. 见后续实例
理解这个任务目标很重要
"""

# ╔═╡ c2320248-4f8f-42cd-a066-c27005f5e87c
md"""
## 中心极限定理
   ...
   **注意表述:多次抽样获取的不同均值组成一个集合.每次抽样获取的均数是样本均数总体里的一个个体**
   ...
   这为们进行少量的抽样实验就可以获取近似的总体均值信息提供依据.
"""

# ╔═╡ 6bcca917-39ce-49f5-8e79-869517ef7176
md"""
 ## 均一分布总体的均数抽样分布
 
 最常见的均一分布是掷色子 
 ![](https://tva1.sinaimg.cn/mw690/e6c9d24egy1h5aq35fwbej222k0a6q47.jpg)
...
# ╔═╡ dc2b7520-77c4-4f86-ac11-b2364cbf20b7
let
	sample5=[]
...
# ╔═╡ 8a5ea7b9-8012-478d-8d46-21259d96d569
let
	sample20=[]
...
# ╔═╡ 19d631af-00bf-4b65-a727-3a098807ac26
let
	sample30=[]
...
# ╔═╡ cc0c4419-c73d-46b1-8453-148827d8a6b2
let
	sample50=[]
...
# ╔═╡ 38da50e0-996d-426d-887b-2533d043e6ec
let
	sample200=[]
	freq=0
...
# ╔═╡ 1923a003-8741-450b-85b3-36e5e10d3974
let
	sample500=[]
	for i in 1:n
...
# ╔═╡ acecbd42-38c8-45d1-893b-7304fd0dbd5e
md"""
## 大数定理(law of large numbers )

上面的一组图说明就是大数定律(law of large numbers), 当采样采用过程中选取的对象数越多, 样本均值分布的的均值收敛于总体均数.  采样中选取的个体(对象, $n$) 度量了从总体中获取信息的水平. 

举个简单的例子,  比如一个地方风景作为总体, 照片的像素点越多, 照片越清楚, 反映总体的细节信息就越多. 这就是大数定律.  
"""

# ╔═╡ f7141c28-61e7-40bb-b145-37a6a9fd4d93
begin
...
# ╔═╡ be973586-0361-4cde-8284-6135c2315250
begin
...
manifest_format = "2.0"
project_hash = "81f6b21b051173da97f871ddd20b9155621ca6e0"
