...
# ╔═╡ ff1a5f94-2b9b-11ed-2b62-0ddd07f55eb9
begin
	using CSV,DataFrames, Lasso, StatsPlots
end

# ╔═╡ 68df3eee-4728-427d-8c53-c6b2d7e71604
begin
	 data = DataFrame(X=[1,2,3], Y=[2,4,7])
end

# ╔═╡ a6f8d63e-d1ea-43a6-9771-ff54319ab0d0
model= fit(LassoModel, @formula(Y ~ X), data)
...
manifest_format = "2.0"
project_hash = "ba3cf45684320e1a12ab8f3d58b1c0040102bfdc"
