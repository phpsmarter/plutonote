...
# ╔═╡ 20fb0a18-1932-11ed-2c10-c1f776a8c5df
begin
	using CSV, Distributions, HypothesisTests,HTTP,DataFrames,Statistics,Plots,RCall,StatsPlots
end

# ╔═╡ 0ba849a6-ff11-4e1e-9019-98b7bb026dfa
begin
	drug=[3,5,1,4,3,5]
	placebo=[4,8, 6,2,1,9]
	df=DataFrame(drug=drug,placebo=placebo)
end

# ╔═╡ 1b384367-6624-4170-8ad0-a08f299cc834
begin
	@rput df

    function R_Whitney(allData)
