...
# ╔═╡ b73833a0-1baf-11ed-3238-d75124ad2d04
begin
	using RCall,Plots,StatsPlots,DataFrames,HypothesisTests,Distributions,CSV,HTTP,Statistics,StatsBase
	getdata(url)=HTTP.get(url).body
    csv(data)=CSV.read(data,DataFrame)
    retrivedata(url)=getdata(url)|>csv
	url="http://127.0.0.1:8080/penguine_data.csv"

end


# ╔═╡ dd7be45c-7bfc-4db0-a491-0cb84c125272
df=retrivedata(url)


# ╔═╡ e0375995-32d6-4bc5-b58d-59f9c2a6c66e
begin
...
manifest_format = "2.0"
project_hash = "6b5825a599aeea1a0e3d2579d693057a33de71a4"
