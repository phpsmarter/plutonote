...
begin
	using Distributions, StatsPlots, Turing,CSV, DataFrames,MCMCChains, Plots,Distances,Random,Symbolics,Latexify,MultivariateStats,PalmerPenguins
	using MLDataUtils: shuffleobs, splitobs, rescale!
	Turing.setprogress!(false);
	penguine="/Users/lunarcheung/Public/github/StatsWithJuliaBook/data/penguine_data.csv"
...
# ╔═╡ 1f842e89-bac0-4665-8281-ed45875bc75c
begin
	 
	Xtrain = Matrix(data[1:2:end,3:5])'
    Xtrain_labels = Vector(data[1:2:end,1])
	# split other half to testing set
	Xtest = Matrix(data[2:2:end,3:5])'
	Xtest_labels = Vector(data[2:2:end,1])
end

# ╔═╡ d1663eaa-147c-4c2b-aef6-95ce50cd3c4d
M = fit(PCA, Xtrain; maxoutdim=2)

# ╔═╡ 3a8d490a-9ddd-4401-bf0d-6842176ac101
Ytest = predict(M, Xtest)

# ╔═╡ f3ce2318-382d-494d-8ad1-7a2acdeda1c2
begin
	Adelie = Ytest[:,Xtest_labels.=="Adelie"]
    Gentoo = Ytest[:,Xtest_labels.=="Gentoo"]
   Chinstrap = Ytest[:,Xtest_labels.=="Chinstrap"]

scatter(Adelie[1,:],Adelie[2,:],ma=0.6,marker=:circle,linewidth=0,label="Adelie")
scatter!(Gentoo[1,:],Gentoo[2,:],ma=0.6,marker=:circle,linewidth=0,label="Gentoo")
scatter!(Chinstrap[1,:],Chinstrap[2,:],ma=0.6,marker=:circle,linewidth=0,label="Chinstrap")
end
...
manifest_format = "2.0"
project_hash = "1a89f7b5520cc3aef5efbd010d4752085d242355"
