...
# ╔═╡ a8e9cd1c-2619-11ed-372f-3d19e8e4b078
begin
	using CSV, Distributions, HypothesisTests,HTTP,DataFrames,Statistics,Plots,RCall,StatsPlots,PlutoUI,StatsBase,PalmerPenguins,AlgebraOfGraphics
	TableOfContents(title="Penguine Corelation")
end

# ╔═╡ f1399fa5-c195-4915-be0d-be512e00822d
begin
	penguins = dropmissing(DataFrame(PalmerPenguins.load()))
    first(penguins, 6)
end

# ╔═╡ 2ca85208-55dc-4d28-913c-0ef02ccf2ebd
bill=select(penguins,3:4)|>d->rename(d,[:bill_length_mm=>:length,:bill_depth_mm=>:depth])

# ╔═╡ b8f3278f-c96b-445c-a951-bbc5414cc959
scatter(eachcol(bill)...,label=false,markeralpha=0.6,ms=4)
...
manifest_format = "2.0"
project_hash = "7e9fc86a0ce0a6359ee987069218fbd82299b106"
