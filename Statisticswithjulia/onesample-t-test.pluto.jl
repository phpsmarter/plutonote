...
# ╔═╡ 25185e6c-1918-11ed-1100-73180a307a55
begin
	using CSV, Distributions, HypothesisTests,HTTP,DataFrames,Statistics,Plots,RCall,StatsPlots
end

# ╔═╡ 04145005-4ebc-4e2b-a2c3-305bf122c362
md"""
# 单样本 t检验

!!! info
    检验样本是不是来自于均值为 $\mu$ 的总体
"""

# ╔═╡ 522c27c1-7b38-4d06-ab19-3e90f2feedb7
begin
...
# ╔═╡ 5bdd5d73-ac2b-43df-809d-e280fefed567
boxplot(["data"],df.data,label=false,outliers=false,size=(250,300))

# ╔═╡ e267c0e6-a20b-429f-9479-9eb3cee85a2f
let
	@rput df
    R"""
	show(t.test(df["data"],mu=15))  #检验样本是不是来自于均值为 15的总体
	"""
end
