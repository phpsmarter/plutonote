...
begin
	...
	irs="/Users/lunarcheung/Public/github/StatsWithJuliaBook/data/iris.csv"
	Random.seed!(0)
...
begin
	 ...
	 X = Matrix(data[1:2:end,3:6])'
     X_labels = Vector(data[1:2:end,1])
end

# ╔═╡ 74171071-5d71-4c88-a89c-dcbeeede62e4
M = fit(MDS, X; maxoutdim=3, distances=false)

# ╔═╡ eca82e15-d875-49bb-a4a3-493ea92bc7ff
Y = predict(M)

# ╔═╡ c8f58e65-75e8-4116-b53b-7f1e6926866f
begin
Adelie = Y[:,X_labels.=="Adelie"]
Gentoo = Y[:,X_labels.=="Gentoo"]
Chinstrap = Y[:,X_labels.=="Chinstrap"]

p = scatter(Adelie[1,:],Adelie[2,:],Adelie[3,:],ma=0.6,marker=:circle,linewidth=0,label="Adelie")
scatter!(Gentoo[1,:],Gentoo[2,:],Gentoo[3,:],ma=0.6,marker=:circle,linewidth=0,label="Gentoo")
scatter!(Chinstrap[1,:],Chinstrap[2,:],Chinstrap[3,:],ma=0.6,marker=:circle,linewidth=0,label="Chinstrap")
...
manifest_format = "2.0"
project_hash = "720d358bddd5c88a4156a96178eb04319695f667"
