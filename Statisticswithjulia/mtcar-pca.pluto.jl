...
# ╔═╡ ed3eda54-28da-11ed-1768-ad76dca7cf6b
begin
	using MultivariateStats,  Plots,StatsPlots,CSV, DataFrames
	using MLDataUtils: shuffleobs, splitobs, rescale!
	
	data_url="/Users/lunarcheung/Public/github/StatsWithJuliaBook/data/mtcars.csv"
end

# ╔═╡ 13268737-56ed-4688-bef4-5ac1296cf79b
data=CSV.read(data_url,DataFrame)

# ╔═╡ c5066ae7-9ac3-45eb-82f1-d7acfb4d9038
names(data)

# ╔═╡ 68559715-601c-4021-9321-e3cee0780e65
begin
	select!(data,[:mpg, :disp, :drat, :wt, :qsec,:hp])
	...
	rescale!(train; obsdim=1)
 #    rescale!(test, μ, σ; obsdim=1)
end

# ╔═╡ 1cf972a7-0e35-4a40-a160-d258859e2fdd
