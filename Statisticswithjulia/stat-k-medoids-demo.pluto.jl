...
# ╔═╡ d79737c0-c18e-4c7e-ba05-ba7cf430ce3a
begin
	using CSV, DataFrames, Clustering,StatsPlots,ScientificTypes
	using MLDataUtils: shuffleobs, splitobs, rescale!
	url="/Users/lunarcheung/Public/github/StatsWithJuliaBook/data/USArrests.csv"
end

# ╔═╡ 0782c988-2ad3-11ed-04d0-91ed79ad77c6
md"""
 # k-medoids  聚类方法 

参考:

[K-Medoids in R: Step-by-Step Example](https://www.statology.org/k-medoids-in-r/)
"""

# ╔═╡ 0335c612-5f3d-4262-b61f-c248a17ec5fe
data=CSV.read(url, DataFrame)|>dropmissing!|>d-> coerce(d, Count => Continuous)


# ╔═╡ 8dc073cc-825c-44ee-ac52-4d8e377ff175
rescale!(data)

# ╔═╡ 5f132529-bf75-4ba5-81ca-55f2f2d1aa5d
feature,state=data[!,:1:4],data[!,:5]
...
manifest_format = "2.0"
project_hash = "6d4fb62a82898e3b40cc1ae512fdc6fbb4504d11"
