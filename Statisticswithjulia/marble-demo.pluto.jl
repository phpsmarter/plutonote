...
# ╔═╡ 66e0277a-a6ac-41b4-9c78-a3a2b07460f7
begin
	using Symbolics,Latexify,RDatasets
	  red,blue="🔴","🔵"
...
# ╔═╡ 2504349a-1d6a-11ed-21fd-eba179dddcd5
begin
r,b="r","b"
data=[b b b b;
      r b b b;
...
p1=[select_color(c) for c in data[:,1]]
p2=[select_color(c) for c in data[:,2]]
p3=[select_color(c) for c in data[:,3]]
p4=[select_color(c) for c in data[:,4]]
end
...
manifest_format = "2.0"
project_hash = "5099d7362f09b07cd2bdd62ae3959143804c2a10"
