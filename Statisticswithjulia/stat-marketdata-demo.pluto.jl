...
# ╔═╡ c13eebe4-245d-11ed-135d-43457a96a124
begin
	using MarketData, DataFrames,Plots
end

# ╔═╡ d0ddd0c2-332b-4a6d-a1ac-b0482a51940d
df = DataFrame(BA)

# ╔═╡ 1544e5b3-a8c1-49dc-b043-482e2682e398
plot(df[:,1],df[:,5],label=false)
...
manifest_format = "2.0"
project_hash = "3d8bb3cff1925ba539c19e46370e9a90b77a54fb"
