...
# ╔═╡ fec7089c-1b17-11ed-3795-e181eff2357f
begin
using DataFrames,RCall,StatsBase

end

# ╔═╡ b999b447-5ec7-4e34-8537-fd6dd740e947
begin
	R"""
...
# ╔═╡ b24bd19c-b36b-42b8-b66e-005f7c063e55
begin
	R"""
...
# ╔═╡ 7748ef2c-4d4d-4268-b6c5-49aa41630546
let
	R"""
...
# ╔═╡ a8fbea79-45eb-4515-aed4-a8324266c7e7
let
	R"""
...
# ╔═╡ bb670e5b-6e52-47f5-9cda-0d85c1c930fe
begin
	a=[1, 3, 4, 6, 11, 14, 17, 20, 22, 23]
	summarystats(a)
end

# ╔═╡ 34f90d76-3e10-41f7-826d-cd962a409464
begin
	R"head(iris)"
end

# ╔═╡ dfa884fe-80e3-4ddc-be34-b8e9cd97084e
begin
	R"""
	...
	#create scatterplot
	  pic=ggplot(iris, aes(x = Sepal.Length, y = Sepal.Width, color = Species)) +
	  geom_point()
...
# ╔═╡ 260ceba1-e851-47e5-9f6b-deb45d66eb21
iris=rcopy(R"cars")
