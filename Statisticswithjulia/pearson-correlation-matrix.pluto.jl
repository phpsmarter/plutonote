...
# ╔═╡ bd512c2e-194f-11ed-1a2d-cd8235ae4663
begin
	using DataFrames,Statistics,Plots,RCall,StatsBase,Latexify,StatsPlots
end

# ╔═╡ fd212f80-c3bd-4d9b-ab31-d21f57ff493b
begin
	assists=[4, 5, 5, 6, 7, 8, 8, 10]
    rebounds=[12, 14, 13, 7, 8, 8, 9, 13]
    points=[22, 24, 26, 26, 29, 32, 20, 14]
	df=DataFrame(assists=assists, rebounds=rebounds,points=points)
    ma=hcat(assists,rebounds,points)
	correlation=cor(ma)
	
end

# ╔═╡ 823d6b42-34dd-4c1c-8a37-7984964b3259
cornerplot(correlation, compact=true ,label = ["assists" "rebounds" "points"])

# ╔═╡ 60b5e276-f2c1-46af-b341-ce5201d86e0d
convariance=cov(ma)

# ╔═╡ e5fab010-24f3-4419-a8ec-6d9ab7b9dd7a
cornerplot(convariance, compact=true,label = ["assists" "rebounds" "points"])

# ╔═╡ a21de8d5-22a5-4d2c-93b2-e566bb9ec62a
X = df[:, 1:3]

# ╔═╡ 0773dcc1-9dfc-446d-83e3-f1379e5f8ad9
convariance2=cov(X)
...
manifest_format = "2.0"
project_hash = "bbc5b44b31bac8627da659e8444b0136ea802464"
