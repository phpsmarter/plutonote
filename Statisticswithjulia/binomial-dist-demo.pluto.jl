...
# ╔═╡ 4cf02214-19fc-11ed-180f-51af4b822e1b
begin
	using  Distributions,DataFrames,Statistics,Plots,RCall,StatsPlots,Random,StatsBase,LaTeXStrings
	Random.seed!(123) 
	
	
end

# ╔═╡ b1b372ac-a4e6-47cb-a581-9104b280387a
begin
    all=0
	n,p=1000,0.5
	d=Binomial(n,p)
	# data=rand(d,300)
 #    bar(pdf(d),label=false)
	for i in 1:10
	  all+=pdf(d,i)
	end
    all
...
# ╔═╡ 44ab495a-76b2-421b-8720-c80d2095c787
...
# ╔═╡ 830220e8-fe24-44f6-889d-92dd0cf46bcc
ksl(d)

# ╔═╡ 552029a7-dd3a-4ad8-a9d7-9087eef53f5b
binomial_pdf(n) =
...
# ╔═╡ ef743124-e9f3-46e7-bd34-06db0aedc773
plot(binomial_pdf.((1,2,4,10))...)

# ╔═╡ 596bb8da-662a-4009-beda-017fba8589ae
begin
d2=Binomial(2)
pdf(d2)
end
...
# ╔═╡ 6b01f582-e489-4916-9619-e8fe26dfa361
begin
md=Multinomial(10, [0.1, 0.4,0.5])
...
manifest_format = "2.0"
project_hash = "d53aa94fe9b866112fc7fc50c341289d76c23aee"
