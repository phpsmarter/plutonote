...
以均值为例, 从当总体中抽取的个体比较多的时候, 样本个体的均值应该近似和总体的均值相差不大, 特别是在抽取的个体数量较多的时候. 
...
function plot_sample2(;n=5)
	...
	xs,ys=rand(sample_span,sample_num).+offset,rand(sample_span,sample_num).+offset
	#println(xs.+offset)
	#println(ys.+offset)
...
# ╔═╡ 256e04fd-9c79-41c1-be13-863cb3db9f3d
function factor(num)
