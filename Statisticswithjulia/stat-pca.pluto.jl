...
# ╔═╡ c047b4ea-24ea-11ed-1b36-4d06defe38d3
begin
	using CSV, Distributions, HypothesisTests,HTTP,DataFrames,MultivariateStats,Statistics,Plots,RCall,StatsPlots,PlutoUI,StatsBase,RDatasets,Latexify,LaTeXStrings,LinearAlgebra
	TableOfContents(title="PCA")
	
end

# ╔═╡ 5b6d735f-42d2-4897-af63-225405450e58
usarrest=dataset("datasets", "USArrests")

# ╔═╡ 2fcbbfbd-064d-4884-8d34-c555b9846e29
begin
	# load iris dataset
...
# ╔═╡ a9b61a97-02e1-4fdd-a852-8ba1dbcc03ae
M = fit(PCA, Xtr;)

# ╔═╡ 08f8f649-79ab-45cb-a714-8d3b8b3c18e8
Yte = predict(M, Xte)

# ╔═╡ 8bcf13dc-9ef0-42d1-b987-3e739f7d0e2a
data=usarrest[:,2:5]|>Matrix

# ╔═╡ d1df7ab7-f33a-4d85-8466-cddfa6c9a924
M2=fit(PCA,data;)

# ╔═╡ 1026ea04-7b76-424e-9d7c-32636ee8c8db
begin
	histogram(usarrest[!,:3],label=false)
	density!(usarrest[!,:3],label=false)
end

# ╔═╡ b0ed4739-63f7-4c6b-93a9-7319c9275391
begin
	pd=Poisson(10)
	rand(pd,100)
end

# ╔═╡ 1a0b6785-3935-4476-a695-5e5b7fbe4994
randn
...
manifest_format = "2.0"
project_hash = "03886a654097c6dd0729fb6e8984332f44d3f737"
