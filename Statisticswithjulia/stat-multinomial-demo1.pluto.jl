...
# ╔═╡ 49b13b5c-2b4e-11ed-088e-ab1f58edd08b
begin
	using DataFrames, StatsPlots, Distributions,LaTeXStrings,Parameters
end

# ╔═╡ ce6bf9f2-beae-481f-ba3c-28dc34d647ee
begin
	d=Multinomial(6,repeat([1/6],6)) #  色子扔 100 次的分布
end

# ╔═╡ 2584fcd7-bd5f-4765-91fe-36a24ba2f249
pdf(d,[1,2,2,1,0,0])

# ╔═╡ bceeb9d7-b47f-4531-87a7-397134e03f98
begin
  @with_kw 	struct Weather{T}
        rain::T=0.2
		cloudy::T=0.4
		sunny:: T=0.4
  end
	...
	p=Weather()
    d2=Categorical([p.rain,p.cloudy,p.sunny])
	
end


# ╔═╡ bdde4f43-02a9-4124-aa8b-4104e3fadaaf
plot(d2)  #概率分布

# ╔═╡ 6b104320-a73a-4b5d-aaa6-44e8487521c9
pdf(d2,3)  # 晴天的概率

# ╔═╡ 2fd86916-8374-40dd-9331-6fec857f9104
begin
	@with_kw 	struct Marble{T}
        yellow::T=0.6
		red::T=0.2
		pink:: T=0.2
  end
	p2=Marble()
	d3=Multinomial(4,[p2.yellow,p2.red,p2.pink])
end

# ╔═╡ d45dfc59-7333-4749-a33f-7be4e1cc1453
pdf(d3,[4,0,0])

# ╔═╡ 7f8a6074-6cf1-4f9c-ae8c-0231d31e853c
d8=Uniform(0, 20)
...
manifest_format = "2.0"
project_hash = "bf2b3960dbb4afce7a828492e11b20d884d82c5a"
