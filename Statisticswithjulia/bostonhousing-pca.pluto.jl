...
# ╔═╡ 52bd6eea-28cf-11ed-01f2-b973f649f38a
begin
	using MultivariateStats,  Plots,StatsPlots,CSV, DataFrames
	...
	data_url="/Users/lunarcheung/Public/github/StatsWithJuliaBook/data/x10.txt"
end

# ╔═╡ 58e2ba4d-43cd-42bb-916f-8d0906156bba
data=CSV.read(train_data_url,DataFrame)

# ╔═╡ d7960ae7-91e0-4a8f-b530-2c200ff7cce9
begin
	trainset, testset = splitobs(shuffleobs(data), 0.7)
	target = :medv
	train = Matrix(select(trainset, Not(target)))'
	test = Matrix(select(testset, Not(target)))'
	train_label =trainset[:, target]|>vec
	test_labelt = testset[:, target]|>vec
end

# ╔═╡ c9f74b5e-ba8d-43ab-b76c-b0d0674eb466
M = fit(PCA, train; maxoutdim=3)

# ╔═╡ 80cabb12-3b34-4d6a-8460-4dd6477fe41d
Ytest = predict(M, test)

# ╔═╡ de396560-d503-415d-bfa6-ecaba4fea08f
Ytrain=predict(M, train)

# ╔═╡ 489af098-75f3-437b-94c0-da70135abfb9
Xtest = reconstruct(M, Ytest)

# ╔═╡ d6834d97-6853-41af-b20d-46d57540fc4e
scatter(Ytest[1,:],Ytest[2,:],Ytest[3,:],label=false,α=0.5,color=:cool)

# ╔═╡ fecf37db-10d0-410f-8e9a-9e514cd42f58
scatter(Ytrain[1,:],Ytrain[2,:],Ytrain[3,:],label=false,α=0.5,color=:spring)

# ╔═╡ 6866ff59-6d82-4ffe-b726-49ef6195cca6
principalvars(M)
...
manifest_format = "2.0"
project_hash = "6f1985897b0e2eebfb450e36147f67f8b4d7c040"
