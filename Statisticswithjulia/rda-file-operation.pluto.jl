...
# ╔═╡ cbcc14da-2b18-11ed-3d0c-0de9e4e2dce4
begin
	using RData,DataFrames,RCall
	import CodecBzip2
	url="/Users/lunarcheung/Downloads/coding/datasets-master/df_bank_marketing_train.rds"
	url2="/Users/lunarcheung/Downloads/coding/datasets-master/BreastCancer.rds"
end

# ╔═╡ 1b15f602-a568-4931-b21d-a3492008b611
data=load(url)

# ╔═╡ 523b5ced-a9ba-493b-9036-cba0b09b999d
data2=load(url2)

# ╔═╡ 20b4f148-b900-481b-8947-2c4df2ef6b62
df=DataFrame([[1,1,3,4,5]],:auto)

# ╔═╡ 1c1f93bc-aa87-45d4-b8fd-3306754e1d9a
begin
	@rput df
	R"""
...
# ╔═╡ f7f42c20-2a0a-47b0-a6a4-261c717fec1c
load("my_data.rda")
...
manifest_format = "2.0"
project_hash = "be68f7865a865862159384691bcd08191cd71907"
