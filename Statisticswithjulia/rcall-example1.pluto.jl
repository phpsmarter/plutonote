...
# ╔═╡ 3f7ecab4-2b1c-11ed-2d34-0d090de9d034
begin
	using RCall
	@rimport base as rbase
	path="/Users/lunarcheung/Downloads/coding/datasets-master/"
end

# ╔═╡ 4fa36e6e-2cfb-4609-87a7-3f9055048384
begin
	@rput path
	R"""
	list.files(path)
...
# ╔═╡ fa004ee2-0d94-441d-b8a6-6bdcd1e0e4d4
R"""
	list.files(path,pattern='txt')
"""

# ╔═╡ b132a957-8e14-44fa-960c-6dfeb8ba45c5
begin
	R"""
...
# ╔═╡ 345ec241-f1a4-4400-848c-5ae2a68ad4aa
R"""
  cor(df)
"""

# ╔═╡ 6b26267e-b249-43dd-8e59-c09c4bbfbc0b
# ╠═╡ show_logs = false
R"""
library(Hmisc) 
library(corrplot) 
data<-rcorr(as.matrix(df))
# 例如 rebounds 和 assists rcorr 为-0.24, p-value 为 0.5589, 说明两者负相关, 但是并没有统计显著差异. 意思是负相关可能只是采样误差引起的
...
manifest_format = "2.0"
project_hash = "45413144b87285c4aa40faf29f782c773ee6d385"
