...
begin
	using Distributions, StatsPlots, Turing,CSV, DataFrames,MCMCChains, Plots,Distances,Random,Symbolics,Latexify,MultivariateStats
	using MLDataUtils: shuffleobs, splitobs, rescale!
	Turing.setprogress!(false);
	data_url="/Users/lunarcheung/Public/github/StatsWithJuliaBook/data/penguins.csv"
...
data=CSV.read(irs,DataFrame)

# ╔═╡ 1f842e89-bac0-4665-8281-ed45875bc75c
begin
	X = Matrix(data[1:2:end,1:4])'
    X_labels = Vector(data[1:2:end,5])
end
...
manifest_format = "2.0"
project_hash = "4ebd25670e741f9b983327ce1e919585f8aad881"
