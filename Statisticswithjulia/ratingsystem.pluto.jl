...
# ╔═╡ 52c35cc8-29ca-11ed-23e7-13b77c252f45
begin
	using LinearAlgebra,Plots,StatsPlots
end

# ╔═╡ 40057ce1-ad72-4da7-b0c8-6363ffe8ffd2
A=[4 -1 -1 -1 -1 ; -1 4 -1 -1 -1 ; -1 -1  4 -1 -1; -1 -1 -1 4 -1;1 1 1 1 1]

# ╔═╡ 9664a2d2-0f84-4ced-b7f3-f3b7cf0b26ca
b=[-124,91,-40,-17,0]

# ╔═╡ 616ab74d-cc71-4f08-b5e5-a6924542962d
 rating=A\b  # 最小二乘法

# ╔═╡ 15f7ef4a-1be9-406e-bb2e-1caca5a2d16a
school=["Duke","Miami","UNC","UVA","VT"]

# ╔═╡ de0b7cdc-0fec-48f0-acdc-97f126403d58
Dict(school=>rating)

# ╔═╡ 8fc538fd-5d1b-40bd-af71-a9713da6eefc
ranking=Dict(["$(school[i])"=>rating[i] for i in 1:5])

# ╔═╡ 18d1c8c0-c852-4794-b907-0bf708cefae9
bar(ranking,label=false)
...
manifest_format = "2.0"
project_hash = "84cec41f8ed308985c1d29afddce2e7a708e661f"
