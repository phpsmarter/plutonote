...
# ╔═╡ 08611a90-1f88-11ed-3239-ddf63e0238d6
begin
    ...
    TableOfContents(title="中心趋势的统计")
end

# ╔═╡ 594608df-8206-4313-be45-203165c395c2
md"""
!!! example
    example 1 
    绘制下面三组数据的频数条状图
...
# ╔═╡ 61282844-d4a6-42e3-8faa-868a6afa62e0
begin
	data1=[1,2, 3, 3, 4, 4,4,5, 5, 5,5,6, 6, 6, 7, 7,8,9]
	data2=[1:5...,6,6,7,7,7,8,8,8,8,9,9]
	data3=[1,1,2,2,2,2,3,3,7,7,8,8,8,8,9,9]
	
end

# ╔═╡ 3e847cb6-398d-4ccf-adb9-d799f0d72eaa
md"data1 中间频数最高, data2 左边拖尾,data3有两个峰值"

# ╔═╡ fe501966-7dcf-4e46-a9b9-f3eaff554bc7
make_dataframe(data)=DataFrame(X=span(data),f=counts(data))

# ╔═╡ 2a2ff96c-64c4-44da-b271-d341dbd0f858
df1,df2,df3=[data1,data2,data3].|>make_dataframe  #df1,df2,df3=make_dataframe.([data1,data2,data3])  #另一种形式的广播操作


# ╔═╡ 6da51921-f676-459c-834e-de5c07bc6703
begin
    p1=bar(df1[:,1],df1[:,2],xlabel=L"(data1)",label=false)
	p2=bar(df2[:,1],df2[:,2],xlabel=L"(data2)",label=false)
	p3=bar(df3[:,1],df3[:,2],xlabel=L"(data3)",label=false)
	plot(p1,p2,p3)
end

# ╔═╡ aaf2f02d-7291-4e45-a9c2-518b47696e0b


# ╔═╡ f9ab753a-beb8-4c5e-95fc-b024afde00ba


# ╔═╡ e6d43deb-ad8f-4dcc-ad6c-76c7d29d3bef


# ╔═╡ a4d42a7a-56cd-4bae-844a-256c615826d1
