...
begin
	using  Distributions,DataFrames,Statistics,Plots,RCall,StatsPlots,Random,StatsBase
	Random.seed!(123) 
	n=1000
	plotly()
end
...
let
	...
	for i in n
		push!(sample5, mean(sample(data, 5)))
	end
...
manifest_format = "2.0"
project_hash = "03768d995ec0a0e26824f6fa5b3893daea381bf9"
