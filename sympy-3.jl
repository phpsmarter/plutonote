...
# ╔═╡ 4b634e4d-db7e-4c91-b96b-5311fc5e0809
begin
	using SymPy,LinearAlgebra,CairoMakie
	@vars x y z
end

# ╔═╡ 376c17e8-c5c6-11ec-1949-09d21fb60068
md"# SymPy with calculus"

# ╔═╡ f0b78b7d-ac18-4a02-aa5c-920457f7f426
diff(cos(x), x)

# ╔═╡ 3e10e167-1e58-4eb8-bd3e-e068479e62b8
diff(x^4, x, x, x)

# ╔═╡ adb05463-af39-4908-81b2-79ba8b81f50b
let
	integrate(cos(x), x)
	
end

# ╔═╡ a58ba415-171f-4ad9-a8f9-eb471debbeda
limit(sin(x)/x, x, 0)
