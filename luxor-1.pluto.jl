...
# ╔═╡ 6cf9c9cd-05b8-420b-a05e-3d45ef694f7b
begin
	using PlutoUI,SymPy,Plots,Luxor,Random
	import Luxor:text
	gr()
	theme(:bright)
...
# ╔═╡ 6145e377-65d3-4d5b-b57a-54ca4ad3d725
let
Drawing(500, 500, "my-drawing.svg")
origin()
sethue("black")
...
# ╔═╡ 5ca8db1d-3905-4a13-a132-dfcd411191bb
let
	Drawing()
	origin()
	Random.seed!(42)
...
# ╔═╡ a8a0ad70-1c7c-4843-8f43-558efccb1935
let
	@svg begin
    setline(10)
    sethue("purple")
...
# ╔═╡ 1b48d4d6-2536-42b0-a72a-834131296d7d
let
...
# ╔═╡ a8cbd338-38da-428b-a208-6f9db079e742
let
	Drawing()
	origin()
