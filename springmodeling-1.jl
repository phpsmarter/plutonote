...
# ╔═╡ 7e39718d-65f6-48db-a7ea-bca1ccc83d39
begin
...
# ╔═╡ 3097a562-c8dd-11ec-28b8-7fb6e9916806
md"# modeling  spring "

# ╔═╡ 0e44bb50-742e-482a-9f21-1c0972d8bb3a
md"## 1.过阻尼弹簧"

# ╔═╡ 08e1608b-4b89-41fa-abdb-98c58841f08c
begin
	z1=(5/3)*ℯ^-t-(2/3)ℯ^-4t #过阻尼震动原函数
	
end

# ╔═╡ 1b4ad4d9-982f-4b89-9a8d-095686837ba2
begin
	tspan=0:0.02:10
	x(t)=(5/3)*ℯ^-t-(2/3)ℯ^-4t
	plot(x,tspan,label="(5/3)*ℯ^-t-(2/3)ℯ^-4t")
	xs=[0.157,0.157]
	ys=[0,x(0.157)]
    plot!(xs,ys,line=:path,ls=:dash)
end

# ╔═╡ 4e6b0b9e-574e-4b93-9c80-0b5820c4a0b6
md"""
$$x(0)=1   弹簧初始位移位于平衡位置下方1个单位处$$   
$$x'(0)=1  弹簧初始速度为向下方1m/s$$
$t_{0}时刻之后, 在x(t=0.157)时 位移达到最大值$
"""

# ╔═╡ 588abbdb-fd56-47f8-98b5-ca5ec64c9e97
x(0.157)

# ╔═╡ 5043b7e7-3109-465d-909e-588160e348e2
md"## 2.临界阻尼"

# ╔═╡ 6527e9ff-0f5b-42e1-bb0c-7fa458a2340f
begin
	
	z2=(-3)*t*ℯ^(-4t) #临界尼震动原函数
	
end

# ╔═╡ 4ea67511-b1fd-4844-95a8-fbb765b98053
let
	tspan=0:0.02:3
	x(t)=(-3)*t*ℯ^(-4t)
	plot(x,tspan,label="(-3)*t*ℯ^(-4t)")
