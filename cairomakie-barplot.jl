...
# ╔═╡ 33cb3cbe-02d8-4cda-96d8-1e24aec89ce9
begin
	using CairoMakie,GLMakie
end

# ╔═╡ 11f39d96-c1cb-11ec-31f6-b555cd57dc85
let
...
barplot!(xs, ys,gap = 0, color = :red, strokecolor = :black, strokewidth =0.2)
lines!(xs, ys)
f
end

# ╔═╡ cfbb76b5-40b3-4805-9acf-12d5f4358498
let
...
# ╔═╡ 6a8ad12c-0453-4d28-8868-0a8fd215c543
let
    x = 1:0.05:10
    y(x) = -x+10
...
# ╔═╡ 15f9fc1c-813e-4736-94fe-c1ffeebeabe3
let
	f = Figure()
   Axis(f[1, 1])
   f1(x,y)=x*y
...
for i in 1:0.5:10
	linesegments!(xs, zs.+i,linewidth=1)
end
