...
# ╔═╡ e2e58c38-07cc-11ed-023c-bd896fc1b818
begin
	using CairoMakie, PlutoUI,HypertextLiteral,LaTeXStrings,Symbolics,LinearAlgebra,RowEchelon,Latexify,WGLMakie
	
end

# ╔═╡ ea2d100a-6adc-41da-81fb-ee856a3497c8
let
    ...
    z2=  [f(X,Y) for X ∈ x, Y ∈ y]
	wireframe(ax,x, y, z)
	lines!(ax,x, y, z2,color=:red)
...
git-tree-sha1 = "a35ff42ec3483eda7f855745590bf18df2fb8002"
