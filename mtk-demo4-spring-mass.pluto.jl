...
# ╔═╡ f4c4f56c-0683-41cc-98fa-f1ad46d6d14c
begin
	using Symbolics, ModelingToolkit, Plots, DifferentialEquations, LinearAlgebra
...
function Mass(; name, m = 1.0, xy = [0., 0.], u = [0., 0.])
    ...
    eqs = Symbolics.scalarize(D.(pos) .~ v)
...
function connect_spring(spring, a, b)
    [
        ...
        Symbolics.scalarize(spring.dir .~ scalarize(a .- b))
    ]
end
...
# ╔═╡ 13cd6af6-13a2-11ed-2901-dd489d51c1f6
md"""
# Spring-Mass-system
"""

# ╔═╡ 2307c3f7-5724-4694-b648-311ee0d57457
parameters(model)

# ╔═╡ 3e91052a-e28b-4936-a58f-7ba9200a38dd
states(model)

# ╔═╡ f7b52b1b-49df-4456-905b-eee95a2aedfa
...
manifest_format = "2.0"
project_hash = "298633e7b2f719dcb2fa2a4c55f82ca9b263f0ad"
...
git-tree-sha1 = "6c0fd08be0dc54f11c224374ad6da743ce6a8ca0"
...
git-tree-sha1 = "001e5e765acdd32536232be9b731caed0bf7bba9"
...
git-tree-sha1 = "75b219d2de55a04c8be38ddabf5cbbd567df1abb"
