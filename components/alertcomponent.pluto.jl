...
# ╔═╡ b63c5b4c-f1b7-11ec-31fb-652a7a10291b
begin
...
# ╔═╡ 96d6cb15-247a-41a3-a41e-a7e15dc3291b
md"""
# Alert component
"""

# ╔═╡ 3318db4e-bb4b-4d3d-a99a-478d795326fc
begin
...
iconcollection=Dict(
  ...
  function alert(infotype="info")
	        IconComponent=iconcollection[infotype]
			cls="alert alert-$(infotype)"
					return (content)->
					 @htl("""
			     <div class="$(cls)">
			  <div class="flex-1">
...
# ╔═╡ 06976e66-3869-408b-836a-e251426e3fcb
infoalert("Hello world!")

# ╔═╡ ce9d5758-d161-4347-9676-371c476eefaa
successalert("success!")

# ╔═╡ 0aeb0d04-de38-4d00-abe8-9fa6ad64a486
warningalert("warning!")

# ╔═╡ d758047f-aba4-4fb5-accb-1857d7c80cf7
erroralert("error!")

# ╔═╡ 9ca5ed4a-4673-4555-acf6-e8a295dca307
@htl("""
