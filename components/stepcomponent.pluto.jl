...
# ╔═╡ 4b730b82-f1c4-11ec-200a-b5526c476724
begin
        using PlutoUI,HypertextLiteral,LaTeXStrings,Symbolics
...
# ╔═╡ 6f45aea3-670c-4401-97c4-26d102e9bec9
md"""
 # step component
"""

# ╔═╡ 2a1c7bfb-c01c-47d4-b533-56ad79c5ed48
data=[
	  Dict("data"=>"Register","type"=>"primary"),
	  Dict("data"=>"Choose a plan","type"=>"secondary"),
	  Dict("data"=>"Purchase","type"=>"success"),
	  Dict("data"=>"Job done!","type"=>"accent")
]

# ╔═╡ 5b099702-2007-49d3-b414-ab38b9147b61
begin

  function renderstep(item)
	  content,contenttype=item["data"],item["type"]
	  cls="step step-$(contenttype)"
	  @htl("""
   ...
   @htl("""
     ...
     <ul class="steps steps-vertical">
        $([renderstep(item) for item in data])
     </ul>        
   """)
   end
...
# ╔═╡ cc2c9238-5ba3-4c19-b508-6f019b9137a8
vstep(data)

# ╔═╡ ae75f3af-26dc-4383-ae4c-ec980283e3b5
hstep(data)

# ╔═╡ 45ea81b0-de52-4b1b-ac0d-a63d14ece4a0
@htl("""
