...
# ╔═╡ 74c628a2-0c95-11ed-2494-4379c21894b7
begin
	using Optimization, Symbolics
end

# ╔═╡ ccca1821-0ad5-424c-8358-dbc9ecc6a0b6
let
using JuMP,HiGHS
...
@objective(model, Min, 500x1+600x2+350x3+400x4+200x5)
@constraint(model, c1, 12x1+20x2+25x4+15x5<=288)
@constraint(model, c2, 10x1+8x2+16x3<=192)
@constraint(model, c3, 20x1+20x2+20x3+20x4+20x5<=384)
print(model)
optimize!(model)
