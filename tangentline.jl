...
# ╔═╡ 6f4ea567-8b3d-4e21-aab2-9b9ffb6f11fa
begin
	using OrdinaryDiffEq, Plots
    gr()
end

# ╔═╡ a29bab68-84bd-11ec-33ad-c9523592c73d
md" # tangent line method "

# ╔═╡ 5368c512-b69d-43e4-b17a-b5d7a55146cd
begin

	f(x)=x^3-0.165*x+3.339/10000
	f2(x)=−0.1575x + 0.0001493
	#y=Int(abs(f2(0.05)))
	span=-0.3:0.01:0.5;
	plot(f,span,label="orginal function")
	plot!(f2,span,label="slope at x=0.05")
	#scatter!(0.05,0.0077)
end
