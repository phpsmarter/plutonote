...
# ╔═╡ 98c79fe6-38c3-4be8-b5fa-928b1116a451
begin
	using SymPy,LinearAlgebra,CairoMakie,Plots
	gr()
end

# ╔═╡ 755b6994-c5c3-11ec-3483-a98e36f52668
md"# Sympy2"

# ╔═╡ 00bce5be-61ab-46f1-a3eb-4cf1275cfed5
begin
	x, y, z = symbols("x y z")
	expr1 = 2^x + x*y
end

# ╔═╡ 57568758-dc0e-4536-b889-e824b5079ef0
begin
	f=2^x + x*y
...
# ╔═╡ 5da35e68-801a-4566-8fa8-fbd28644d0f3
 x/y

# ╔═╡ 6aa67709-9a8b-46cd-b385-f66100a16013
1+x

# ╔═╡ 6eaab4b4-98cd-4dd0-b9c1-243100373ff7
x+y

# ╔═╡ 8c99209a-432e-4c7f-bb42-c5c7e837c07f
3*y^2*x

# ╔═╡ 81a14828-c2fb-4fa6-8f2b-1f0d53d9db0c
expr3=3*y^(2*x)

# ╔═╡ 5bbbbd70-84e9-45fe-8430-d8437f08e96e
@vars u
