...
# ╔═╡ ad8a73c3-de3c-4a36-b893-e246110c9662
begin
	using AlgebraOfGraphics,CairoMakie
	
end

# ╔═╡ a066865c-c1c5-11ec-3d1f-b5bb181e09bd
md"# cairomakie affine line "

# ╔═╡ 0f462633-eb7d-45b9-b63e-3de00e5ff58c
begin
	fig, ax, pl = scatter(1:4)
	abline!(ax, 0, 1)
	abline!(ax, 0, 1.5, color = :red, linestyle=:dash, linewidth=2)
	abline!(ax, 1, 1.5, color = :green, linestyle=:dash, linewidth=4)
	fig
