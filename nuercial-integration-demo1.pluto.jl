...
# ╔═╡ e072c964-17c3-11ed-38d9-6977f28ab882
begin
	using Symbolics, Unitful, Latexify,QuadGK
	Latexify.set_default(; starred=true)
end

# ╔═╡ 618798f5-dd1c-4c8a-9261-4ac0d297a405
begin
 sup = (-1,1)
 f1(x) = 3/4*(1-x^2)
 f2(x)=x<0 ? x+1 : 1-x
...
# ╔═╡ 753e2e92-f8b5-4d3a-a404-b3283510603d
begin
	a,b=-2pi,2pi
	quadgk(sin, a,b)[1]
end

# ╔═╡ 06ed09e4-92ab-423f-a683-4d4f202063e8
let
	@variables a, b, co, bell,x
	 a,b=-100,100
	 co=1/√(2π)
	 
	 bell(x)=co*ℯ^(-(x^2/2))
	 latexify(bell(x),unfold=true)
	 quadgk(bell,a,b)[1]
end
...
manifest_format = "2.0"
project_hash = "82cdb7faf49723e0a7a359dfa13be97c7f201e10"
