...
# ╔═╡ 3ec35bec-1862-46d1-90c0-5f9aeb7be44e
begin
...
# ╔═╡ c20832da-c5d3-11ec-0fbd-2d850c473c02
md"# using modeling tool kit "

# ╔═╡ 8d6bd604-9e20-4463-9ec1-176dc14b1b1d
begin
	...
	prob = ODEProblem(structural_simplify(fol_separate), [x => 0.0], (0.0,10.0), [τ 
     => 3.0])
	sol = solve(prob)
	plot(sol, vars=[x,RHS])
end
