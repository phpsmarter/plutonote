...
# ╔═╡ 95215666-c5d8-11ec-33b4-cb787d5b56ad
begin
	using Symbolics
	@variables x y t     # 定义三个变量
	D = Differential(t)  # 定义微分算子
end

# ╔═╡ b02e68e6-b91a-4537-8689-51c338bf4a33
begin
	z = x^2 + y
end

# ╔═╡ 583ac52b-4d0e-49c3-8a79-322493d2af86
md">以数组形式传递函数参数效率很高, 类似于你干活需要有很多工具, 把工具放到工具箱里,这时候需要什么工具的时候直接取出来用就可以了, 不需要在用的时候慢慢去找工具在那里."

# ╔═╡ 78f7c1ba-c041-410c-859a-f10523b4d34a
begin
...
# ╔═╡ 14e2181b-8aa7-4458-baf1-a14d1cdfd401
let
	z = t + t^2
	dz=expand_derivatives(D(z))
	
end

# ╔═╡ 44368169-b68d-4669-bdb6-d84476be342e
begin
