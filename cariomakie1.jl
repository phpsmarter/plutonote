...
# ╔═╡ 96e5aa70-3045-4300-a54b-efbd6817a6ea
begin
	using AlgebraOfGraphics,CairoMakie
end

# ╔═╡ c0ea76b6-c104-11ec-0b05-69a2373b1b32
md"# beautiful cairomakie"

# ╔═╡ f1d56bc3-0a69-4c9e-8ac7-e554bbe922f0
let
    x = LinRange(0, 2π, 50)
...
# ╔═╡ 8e42a0b6-648a-4257-b8b2-bfcf267ba13b
let
    x = LinRange(0, 2π, 50)
    fig = Figure(resolution = (600, 400))
...
# ╔═╡ 5f9286af-a775-42b7-8ac9-aaeeb68d07ba
md"## line with inset heatmap"

# ╔═╡ 99956bf6-831e-486e-9cbe-231c6c824425
let
    x = y = -10:0.11:10
    y1d = sin.(x) ./ x
    # 3D heatmap
...
# ╔═╡ 77dd2f89-5f05-4bb7-92cb-a0d3884f5e15
let
    x = 0:0.05:1
    y = -x
    fig = Figure(resolution = (600, 600))
    ax = Axis(fig[1, 1], xlabel = "x", ylabel = "y")
    lines!(x, y, color = :orangered, label = "分类面")
    band!(x, fill(0, length(x)), y; color = (:orange, 0.25), label = "分类面")
    axislegend(; merge = true, position = :lt)
	
    fig
end

# ╔═╡ c9597116-779b-4795-b659-978f7f181dcf
let
    x = 0:0.05:1
    y = x .^ 2
	r(x)=x
    ...
    band!(x, fill(0, length(x)), r.(y); color = (:orange, 0.25), label = "Label")
    axislegend(; merge = true, position = :lt)
    fig
end

# ╔═╡ 795e2ee7-9210-4a6f-a4f9-b9135caf4613
md"## bell shape curve"

# ╔═╡ 266b1837-61b3-4786-ba35-1a53e0015f2c
let
    μs = [0.25, 2, -1]
    σs = [1.25, 1, 2]
