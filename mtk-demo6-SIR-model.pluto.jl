...
# ╔═╡ 5c73026f-5415-4fbf-8ac4-8860f05a8e50
begin
...
@parameters κ ,p    # parameters
D = Differential(t) # define an operator for the differentiation w.r.t. time

# your first ODE, consisting of a single equation, indicated by ~
@named fol = ODESystem([ D(x)  ~ κ*x])



prob = ODEProblem(fol, [x => 1], (0.0,10.0), [κ=>0.5906 p=>1000])
sol = solve(prob)
plot(sol)
end

# ╔═╡ d8c87d9e-13a9-11ed-2832-b922f2858bd7
md"""
# 传染模型
"""
...
manifest_format = "2.0"
project_hash = "bef2d8b28e398c0be3e923bf1fb07db2a1d25573"
