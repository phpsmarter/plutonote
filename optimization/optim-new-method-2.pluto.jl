...
# ╔═╡ 4cfe2ece-326e-11ed-00b1-f3169348414e
begin
	using  Plots, LaTeXStrings,Latexify,LinearAlgebra,Calculus
end

# ╔═╡ 37e210b0-4eee-4338-8612-f3f09fd66368
fun=powell(u)=(u[1]+10u[2])^2+5(u[3]-u[4])^2+(u[2]-2u[3])^4+10(u[1]-u[4])^4 

# ╔═╡ 1e849c6b-99df-4e67-8f7d-d259e32b1a14
∇f=Calculus.gradient(powell)  #函数梯度

# ╔═╡ 42487bfd-4daf-45c5-84d8-a0964201d38d
H=hessian(powell)  # 函数黑塞矩阵

# ╔═╡ a29290c7-5d62-4a22-960f-cc14b8966f3b
...
# ╔═╡ 2d481306-e68b-41ec-92d2-783d1b2bd1d3
x₀=[3,-1,0,1]|>float  # 值需要转位浮点数

# ╔═╡ e7524cd3-df85-4358-af0d-21fa405303bd
∇f(x₀)

# ╔═╡ f32f6078-d2b6-465a-9b32-3a9245cff863
H(x₀)

# ╔═╡ 3c94c72c-8958-48a2-aaf0-f36b60917450
iter(k)=newtons_method(∇f,H,x₀,k)|>fun

# ╔═╡ da2c4ef2-66d1-462d-abf6-770216a64a59
begin
	span=1:10
	val=[iter(k) for k in  span]
end

# ╔═╡ 0e35f1e2-5664-4f47-bf97-2688b0f62497
plot(span,val,xlabel=L"iteration", ylabel=L"value",label=false,size=(400,300))
