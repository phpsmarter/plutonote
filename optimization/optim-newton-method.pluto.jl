...
# ╔═╡ 00bce67a-3239-11ed-0d6f-934fbc48022b
begin
	using Symbolics, Plots, LaTeXStrings,Latexify,LinearAlgebra
end

# ╔═╡ 2bf44180-bec0-4ae4-b7d4-cbfc5912e207
md"""
# 使用牛顿法求解$Powell$ 函数的最小值
"""

# ╔═╡ 6dc7eaea-38f2-49d0-a2b2-73dd9c04e773
begin
...
# ╔═╡ 482597b6-a47a-40ff-960a-b03e652c2d53
org_f(u)=(u[1]+10u[2])^2+5(u[3]-u[4])^2+(u[2]-2u[3])^4+10(u[1]-u[4])^4  # for computer

# ╔═╡ 0df6f692-f573-4313-9ca5-1e8a3ac4dad5
begin
	vars=[x₁,x₂,x₃,x₄]
	xk(x)=Pair.(vars,x)|>Dict  #用于生成带入表达式的字典 substitute(ex, Dict([x => z, sin(z) => z^2]))
end

# ╔═╡ 162eea5a-f5c4-4527-a041-eb84e1083ae9
get_val(x)=substitute(powell,xk(x))

# ╔═╡ 7ce517b7-33e1-4134-afe8-edc122c21f03
md"""
## 准备工作
求解函数梯度和黑塞矩阵
"""

# ╔═╡ 31f79c8f-83f6-4a99-a13b-8d341bb01334
∇f=Symbolics.gradient(powell,vars)  # 函数梯度

# ╔═╡ 467aee0a-0403-4fc4-b892-2ccce0143b60
grad(x)=substitute(∇f,xk(x))

# ╔═╡ 367d3a9e-007a-4fea-b300-78e46d214350
hess=Symbolics.hessian(powell,vars)   #黑塞矩阵

# ╔═╡ 27310ef3-4822-4f73-946f-0803228e172e
H(x)=xk(x)|>d->substitute(hess,d) #遍历方法

# ╔═╡ fb16193a-ecab-4118-ba78-f414d9577e72
md"""
##  1.第一次迭代
"""

# ╔═╡ 1ba84e45-f1d7-4f13-9bbc-737ee6db2b53
x₀=[3,-1,0,1]   # 从这点开始  

# ╔═╡ f28f35b9-162c-467c-9d3a-fb147e008e42
fx1=H(x₀)

# ╔═╡ ad01f4b3-9851-4f05-bbca-6c3e47f4c291
inv_fx1=inv(fx1)

# ╔═╡ 8e4689ef-4900-41ee-bf2f-be7239d1cd83
g1=grad(x₀)

# ╔═╡ 784c5cfd-bab9-40df-9342-67e965ad853d
desc1=inv_fx1*g1

# ╔═╡ c23f8886-03ef-4e2f-9d93-b76a74b7bd6f
x1=x₀-desc1

# ╔═╡ d3c78aad-dfb8-4a20-9fbf-1d4f25790e0f
org_f(x1)  #第一次迭代点的函数值

# ╔═╡ 65617572-665c-4ee1-9d34-37ebe4dcec20
md"""
## 第二次迭代
"""

# ╔═╡ f218aa2f-9747-406c-9d21-9e22feb01215
g2=substitute(∇f,xk(x1))

# ╔═╡ dd5990b1-ce84-414b-9fba-7e86c403190b
fx2=H(x1)

# ╔═╡ 4711cde7-7b2b-413e-994a-92b77c5f2a0d
inv_fx2=inv(fx2)

# ╔═╡ 7b370d0c-5299-47ed-b598-520800ecb506
desc2=inv_fx2*g2

# ╔═╡ 6b536b83-2700-4265-bd2f-dea19fd0ec8d
x2=x1-desc2

# ╔═╡ 9f3b662a-cce7-49e3-a55b-408c776c6c1b
org_f(x2)  #第二次迭代点的函数值

# ╔═╡ 94d998d5-05cb-4cfc-81e1-9ac3ab22e28d
md"""
## 3.第三次迭代
"""

# ╔═╡ ec18c061-d106-4f17-8ca0-7c3f3e8ae108
g3=substitute(∇f,xk(x2))

# ╔═╡ 15fdb929-614d-4f76-9046-929dd0f05b9d
fx3=H(x2)

# ╔═╡ 2beef694-315f-4ac9-952a-905939b3faa4
inv_fx3=inv(fx3)

# ╔═╡ 8bfd9886-33e4-419a-afd0-fd7a4a3f82fe
desc3=inv_fx3*g3

# ╔═╡ 8bd40710-2951-4c5f-bcc9-f7a95c7ba0e2
x3=x2-desc3

# ╔═╡ 30f81b6b-c436-4cd8-a483-e71256bfca2a
org_f(x3) #第三次迭代点的函数值

# ╔═╡ 2feda72c-f1ea-42a2-b346-d8b3eaf51763
md"""
## 4. 第四次迭代
将整个流程整合起来
"""

# ╔═╡ e470d82c-ab95-4143-9046-63ec534a41ef
begin
...
# ╔═╡ a22bbf49-1335-4899-81d5-8c78ee716bd3
function minf(x)
	# 上面函数包装一下
    g=substitute(∇f,xk(x))
	fx=H(x)
...
# ╔═╡ 1fae245e-cb6c-457b-be77-e4d88750290d
md"## 第五次迭代"

# ╔═╡ bf5f020b-cc05-4325-ad01-50b8d013c97f
begin
	#使用包装方法
	minf(x4)|>org_f
end

# ╔═╡ 4bc5f04b-0cc1-4384-898b-7831af080e77
md"""
## 定义牛顿方法
"""

# ╔═╡ 0dcd731c-042f-482d-88bd-7632e5f5d5b3
...
# ╔═╡ 92e516a3-b0bf-44b5-9e5d-834989507e3e
get_value(k)=newtons_method(grad,H,x₀,k)|>get_val|>d->Symbolics.value(d)|>d->round(d,digits=3)

# ╔═╡ 72fca5e3-5484-412e-9c40-8437465b0bd4
arr=[get_value(k) for k in 1:10]

# ╔═╡ 6412ce5d-a794-4074-b9c2-b85d59894224
begin
	span=1:1:length(arr)
	plot(span,arr,label=L"value",xlabel=L"iterations",ylabel=L"value")
end

# ╔═╡ f71cf59c-5898-4800-8f0d-624e917da0ce
L"Powell(X)=(x₁+10x₂)^2+5(x₃-x₄)^2+(x₂-2x₃)^4+10(x₁-x₄)^4"
