...
# ╔═╡ 3649c262-322b-11ed-37ba-c56eca3f8f02
begin
	using Symbolics, Plots, LaTeXStrings,Latexify,LinearAlgebra
end

# ╔═╡ 598bdaa2-2e6a-4d7a-9086-2de42bf80b58
md"""
Algorithms for Optimization- p91
"""

# ╔═╡ 4e5db2a6-1beb-419d-ac4c-8d8c6dbd00cc
begin
	 @variables x₁,x₂,y(x₁,x₂),∇f , xk,d		
	 y=x₁*(x₂^2)	
	 xk=[1,2]
	 ∇f=Symbolics.gradient(y,[x₁,x₂])
	 
    
end

# ╔═╡ 825c7dbd-5c6a-4b57-beb9-77182f8eb0d8
let
	f(x₁,x₂)=(x₁)^2/5+(x₂)^2
	span=-3:0.2:3
	zs=[f(x1,x2) for x1 in span , x2 in span]
	p1=wireframe(span,span,zs,label=false)
	 p2=contour(span,span,zs,label=false)
	 plot(p1,p2)
end
