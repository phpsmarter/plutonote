...
# ╔═╡ 42fff9d6-16c9-11ed-26bf-0beaedc2f38e
begin
	using SymbolicIntegration, SymbolicUtils,Latexify,Symbolics
	Latexify.set_default(; starred=true)
end

# ╔═╡ 48329016-3dbb-4993-a4db-9a38a7daa44a
begin
	@syms x
end

# ╔═╡ 1a8299c6-885b-44d9-83dd-73318bf566e5
f = (x^3 + x^2 + x + 2)//(x^4 + 3*x^2 + 2)

# ╔═╡ de9da372-0d56-4c41-81d8-3a355902c091
let
	@variables n,sₙ(n)
	sₙ~(n*(n+1))//2
end

# ╔═╡ 6196ce75-9051-428d-88ee-df460d167407
let
	@variables  A
	A = Set([2,7,2,3])
...
manifest_format = "2.0"
project_hash = "03e882a2a12dcbd31a9a812f75ea3e822c737236"
...
git-tree-sha1 = "797e092759cee9e0774f01e93e03c1101fea85d3"
uuid = "e21ec000-9f72-519e-ba6d-10061e575a27"
version = "0.200.501+0"

[[deps.Arb_jll]]
deps = ["Artifacts", "FLINT_jll", "GMP_jll", "JLLWrappers", "Libdl", "MPFR_jll", "Pkg"]
git-tree-sha1 = "a369ed24b32ab86b49089425f0b6984d425ddafe"
uuid = "d9960996-1013-53c9-9ba4-74a4155039c3"
version = "200.2000.1+0"
...
git-tree-sha1 = "fb9c8b6b771e675c9e391d1d92f1a8663ab19bc8"
...
deps = ["AbstractAlgebra", "Logging", "Nemo", "SymbolicUtils"]
git-tree-sha1 = "e93461885d90135c39d97e560c9f3efe61951278"
