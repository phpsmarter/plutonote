...
# ╔═╡ 270ccbd0-0c71-11ed-32f0-5db4766e96ed
begin
	 using PlutoUI, Plots,DataFrames,HypertextLiteral,LaTeXStrings,Symbolics,LinearAlgebra,RowEchelon,Latexify,Polynomials,AbstractAlgebra
        gr()
        theme(:bright)
...
# ╔═╡ 3806efd9-6a75-44a1-a0c1-090e3ac08098
let
	@variables  λ,poly
	M = matrix(ZZ, BigInt[3 1 2; 2 0 1;3 9 1])
	I=identity_matrix(ZZ,3 )
	M,I=Matrix(M),Matrix(I)
	latexify(I)
	poly=M-λ*I |> det |>expand
